...
Route::group ([ 'middleware' => [ 'api', 'cors']], static function () {
    ...
    Route::get('/keyword/stats', [KeywordController::class, 'tagStats']);
    Route::get ( 'keyword/{id}' , [ KeywordController::class, 'show' ]);
    Route::get ('/keyword/resolve/{id}', [KeywordController::class, 'resolve']);
    ...
    Route::post('/keyword/upload', [KeywordController::class, 'uploadImage']);
});
// 投票関連API
Route::group ([ 'middleware' => [ 'api', 'cors']], static function () {
