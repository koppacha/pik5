...
1. 当サイトでは、スコア情報を偽って投稿することはその内容や程度にかかわらず絶対に禁止します。
   ただし不可抗力による投稿ミスの場合、すみやかに管理人に報告するか削除機能で削除すれば違反状態を免れるものとします。
...
1. その他、他ユーザー（管理人含む。以下同様）にとって迷惑となるような投稿、当サイトの主旨を逸脱するような投稿、プロモーションコードの記載やアフィリエイトリンクなど一部の人が一方的に利するような投稿はできません。
...
1. ピクチャレ大会開発リポジトリへコミットされたコードは原則オープンソースとなり、著作権は管理人に帰属します。
