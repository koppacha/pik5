...
1. 当サイトでは、公序良俗に反する投稿・発言や、犯罪、自傷、自殺等を正当化するような投稿・発言は認めません。
...
1. 当サイトでは、時事問題、社会問題、恋愛を含む性的な話題、政治的主張、宗教的主張など、立場の違いによって論争の元になりやすいような内容の投稿・発言は認めません。
...
1. Discordをピクミンプレイヤーとしての交流以外の目的、例えば異性との出会いや友達作り、またはコミュニティ空間の私物化やそれに類する行為を目的として利用することを禁止します。
