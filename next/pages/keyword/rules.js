...
1. 当サイトはレトロゲームも扱うスコアランキングという性質上、証拠画像や証拠動画の偽造は容易です。
   ...
   すべてのユーザーは、ランキングが信用されるためにはコミュニティ内で不正を許さない風潮が必要であることを認識し、その維持に努めなければなりません。
1. 前項の具体的な実践方針として、当サイトでは[相互承認の基本理念](./168ee2d5ed0fe)を掲げ、ユーザーに実践を促すこととします。
...
1. 当サイトでは、公序良俗に反する文章や名称を投稿することはできません。ただしピクミンシリーズ公式により言及されている内容に関してはこのかぎりではありません。
   また、本項の適用範囲は当サイトによって管轄するDiscordサーバー全体にも及びます。
