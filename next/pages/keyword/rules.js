...
1. 前項に加えて、本規約が指定するリンク先の文書もユーザーが守るべきルールとして扱います。これには各ランキングのレギュレーション等が含まれます。
...
1. 当サイトは、反社会的な主張をしている者や、ピクミンシリーズや管理人、ピクミン界隈のアンチとして活動している者は利用することができません。
1. 当サイトは、過去にピクミン界隈の一部または全部に対して著しい迷惑をかけた者（永久出禁対象者）のうち、反省の意思が無い場合は利用することができません。
また表面上は反省の意思があっても、その損害を回復させることが困難な場合は反省の意思を認めないことがあります。なお、永久出禁対象者リストはいかなる理由があっても公表しません。
1. 当サイトは、過去に利用規約違反を疑われ、潔白証明ができていない者も利用することはできません。
...
特に改造ROMや改造本体を用いた記録を通常ランキングへ投稿することは絶対に禁止します。ただしタイプミスやレギュレーションの更新により過去の投稿が違反対象となった場合等、投稿者が意図しない違反は本項の対象外とします。
...
1. その他、他ユーザー（管理人含む。以下同様）にとって迷惑となるような投稿、当サイトの主旨を逸脱するような投稿、アフィリエイトなど一部の人が一方的に利するよう投稿はできません。
...
1. ピクミン界隈を対象として、SNS等内外においてピクミン以外のゲームを主体としたイベントを開催することは原則として禁止します。
