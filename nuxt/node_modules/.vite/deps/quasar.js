...
function applyClientSsrCorrections() {
  ...
  let t = e;
  void 0 !== iosCorrection && (t = t.replace("desktop", "platform-ios mobile")), true === client.has.touch && (t = t.replace("no-touch", "touch")), true === client.within.iframe && (t += " within-iframe"), e !== t && (document.body.className = t);
}
...
function useRouterLink({ fallbackTag: e, useDisableForRouterLinkProps: t = true } = {}) {
  const o = getCurrentInstance(), { props: n, proxy: a, emit: l } = o, r = vmHasRouter(o), i = computed(() => true !== n.disable && void 0 !== n.href), s = computed(true === t ? () => true === r && true !== n.disable && true !== i.value && void 0 !== n.to && null !== n.to && "" !== n.to : () => true === r && true !== i.value && void 0 !== n.to && null !== n.to && "" !== n.to), u = computed(() => true === s.value ? b(n.to) : null), c = computed(() => null !== u.value), d = computed(() => true === i.value || true === c.value), p = computed(() => "a" === n.type || true === d.value ? "a" : n.tag || e || "div"), v = computed(() => true === i.value ? { href: n.href, target: n.target } : true === c.value ? { href: u.value.href, target: n.target } : {}), m = computed(() => {
    if (false === c.value)
      return -1;
  ...
  return { hasRouterLink: c, hasHrefLink: i, hasLink: d, linkTag: p, resolvedLink: u, linkIsActive: f, linkIsExactActive: h2, linkClass: g, linkAttrs: v, getLink: b, navigateToRouterLink: y, navigateOnClick: S };
}
var QBreadcrumbsEl = createComponent({ name: "QBreadcrumbsEl", props: { ...useRouterLinkProps, label: String, icon: String, tag: { type: String, default: "span" } }, emits: ["click"], setup(e, { slots: t }) {
  const { linkTag: o, linkAttrs: n, linkClass: a, navigateOnClick: l } = useRouterLink(), r = computed(() => {
  ...
  }), i = computed(() => "q-breadcrumbs__el-icon" + (void 0 !== e.label ? " q-breadcrumbs__el-icon--with-label" : ""));
  return () => {
    const n2 = [];
...
function showRipple(e, t, o, n) {
  ...
  l = true === l || true === n;
  const r = document.createElement("span"), i = document.createElement("span"), s = position(e), { left: u, top: c, width: d, height: p } = t.getBoundingClientRect(), v = Math.sqrt(d * d + p * p), m = v / 2, f = `${(d - v) / 2}px`, h2 = l ? f : `${s.left - u - m}px`, g = `${(p - v) / 2}px`, b = l ? g : `${s.top - c - m}px`;
...
function useBtn(e) {
  const t = useSize(e, defaultSizes$2), o = useAlign(e), { hasRouterLink: n, hasLink: a, linkTag: l, linkAttrs: r, navigateOnClick: i } = useRouterLink({ fallbackTag: "button" }), s = computed(() => {
...
var QBtn = createComponent({ name: "QBtn", props: { ...useBtnProps, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] }, emits: ["click", "keydown", "mousedown", "keyup"], setup(e, { slots: t, emit: o }) {
  const { proxy: n } = getCurrentInstance(), { classes: a, style: l, innerClasses: r, attributes: i, hasLink: s, linkTag: u, navigateOnClick: c, isActionable: d } = useBtn(e), p = ref(null), v = ref(null);
  let m, f, g = null;
  ...
  }), x = computed(() => ({ ref: p, class: "q-btn q-btn-item non-selectable no-outline " + a.value, style: l.value, ...i.value, ...C.value }));
  function k(t2) {
    if (null !== p.value) {
      if (void 0 !== t2) {
  ...
  function q(e2) {
    null !== p.value && (o("touchstart", e2), true !== e2.defaultPrevented && (touchTarget !== p.value && (null !== touchTarget && $(), touchTarget = p.value, g = e2.target, g.addEventListener("touchcancel", P, passiveCapture), g.addEventListener("touchend", P, passiveCapture)), m = true, clearTimeout(f), f = setTimeout(() => {
      m = false;
    }, 200)));
  }
  function T(e2) {
  ...
  function $(e2) {
    const t2 = v.value;
    true === e2 || touchTarget !== p.value && mouseTarget !== p.value || null === t2 || t2 === document.activeElement || (t2.setAttribute("tabindex", -1), t2.focus()), touchTarget === p.value && (null !== g && (g.removeEventListener("touchcancel", P, passiveCapture), g.removeEventListener("touchend", P, passiveCapture)), touchTarget = g = null), mouseTarget === p.value && (document.removeEventListener("mouseup", P, passiveCapture), mouseTarget = null), keyboardTarget === p.value && (document.removeEventListener("keyup", P, true), null !== p.value && p.value.removeEventListener("blur", P, passiveCapture), keyboardTarget = null), null !== p.value && p.value.classList.remove("q-btn--active");
  }
  function M(e2) {
...
function useAnchor({ showing: e, avoidEmit: t, configureAnchorEl: o }) {
  ...
  return void 0 === o && (Object.assign(u, { hide(e2) {
    ...
    p(), true !== t && true === n.modelValue && null === r.value && l("update:modelValue", false);
  }), onBeforeUnmount(() => {
    clearTimeout(i), c();
...
function usePortal(e, t, o, n) {
  ...
  return onUnmounted(() => {
    c(true);
  }), e.proxy.__qPortal = true, injectProp(e.proxy, "contentEl", () => t.value), { showPortal: u, hidePortal: c, portalIsActive: a, portalIsAccessible: l, renderPortal: () => true === s ? o() : true === a.value ? [h(Teleport, { to: r }, o())] : void 0 };
}
...
var QMenu = createComponent({ name: "QMenu", inheritAttrs: false, props: { ...useAnchorProps, ...useModelToggleProps, ...useDarkProps, ...useTransitionProps, persistent: Boolean, autoClose: Boolean, separateClosePopup: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, fit: Boolean, cover: Boolean, square: Boolean, anchor: { type: String, validator: validatePosition }, self: { type: String, validator: validatePosition }, offset: { type: Array, validator: validateOffset }, scrollTarget: { default: void 0 }, touchPosition: Boolean, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null } }, emits: [...useModelToggleEmits, "click", "escapeKey"], setup(e, { slots: t, emit: o, attrs: n }) {
  ...
  function D(e2) {
    a = void 0, void 0 !== l && (l(), l = void 0), true !== e2 && true !== p.value || (removeFocusout(V), x(), removeClickOutside(M), removeEscapeKey(N)), true !== e2 && (i = null);
  }
  function z() {
  ...
  function V(t2) {
    true === O.value && true !== e.noFocus && true !== childHasFocus(d.value, t2.target) && F();
  }
  function N(e2) {
    o("escapeKey"), q(e2);
  }
  ...
  function j() {
    return h(Transition, y.value, () => true === p.value ? h("div", { role: "menu", ...n, ref: d, tabindex: -1, class: ["q-menu q-position-engine scroll" + E.value, n.class], style: [n.style, S.value], ...A.value }, hSlot(t.default)) : null);
  }
  return watch(O, (e2) => {
    true === e2 ? (addEscapeKey(N), addClickOutside(M)) : (removeEscapeKey(N), removeClickOutside(M));
  }), onBeforeUnmount(D), Object.assign(u, { focus: F, updatePosition: H }), $;
} });
var buf;
var bufIdx = 0;
...
var QBtnDropdown = createComponent({ name: "QBtnDropdown", props: { ...useBtnProps, ...useTransitionProps, modelValue: Boolean, split: Boolean, dropdownIcon: String, contentClass: [Array, String, Object], contentStyle: [Array, String, Object], cover: Boolean, persistent: Boolean, noRouteDismiss: Boolean, autoClose: Boolean, menuAnchor: { type: String, default: "bottom end" }, menuSelf: { type: String, default: "top end" }, menuOffset: Array, disableMainBtn: Boolean, disableDropdown: Boolean, noIconAnimation: Boolean, toggleAriaLabel: String }, emits: ["update:modelValue", "click", "beforeShow", "show", "beforeHide", "hide"], setup(e, { slots: t, emit: o }) {
  const { proxy: n } = getCurrentInstance(), a = ref(e.modelValue), l = ref(null), r = uid$3(), i = computed(() => {
...
var QBtnToggle = createComponent({ name: "QBtnToggle", props: { ...useFormProps, modelValue: { required: true }, options: { type: Array, required: true, validator: (e) => e.every((e2) => ("label" in e2 || "icon" in e2 || "slot" in e2) && "value" in e2) }, color: String, textColor: String, toggleColor: { type: String, default: "primary" }, toggleTextColor: String, outline: Boolean, flat: Boolean, unelevated: Boolean, rounded: Boolean, push: Boolean, glossy: Boolean, size: String, padding: String, noCaps: Boolean, noWrap: Boolean, dense: Boolean, readonly: Boolean, disable: Boolean, stack: Boolean, stretch: Boolean, spread: Boolean, clearable: Boolean, ripple: { type: [Boolean, Object], default: true } }, emits: ["update:modelValue", "clear", "click"], setup(e, { slots: t, emit: o }) {
  const n = computed(() => void 0 !== e.options.find((t2) => t2.value === e.modelValue)), a = computed(() => ({ type: "hidden", name: e.name, value: e.modelValue })), l = useFormInject(a), r = computed(() => getBtnDesignAttr(e)), i = computed(() => ({ rounded: e.rounded, dense: e.dense, ...r.value })), s = computed(() => e.options.map((t2, o2) => {
...
function usePanel() {
  ...
  return watch(() => e.modelValue, (e2, o2) => {
    ...
    true !== l && x(-1 === n2 ? 0 : n2 < w(o2) ? -1 : 1), r.value !== n2 && (r.value = n2, t("beforeTransition", e2, o2), nextTick(() => {
      t("transition", e2, o2);
    }));
...
function useCheckbox(e, t) {
  const { props: o, slots: n, emit: a, proxy: l } = getCurrentInstance(), { $q: r } = l, i = useDark(o, r), s = ref(null), { refocusTargetEl: u, refocusTarget: c } = useRefocusTarget(o, s), d = useSize(o, optionSizes), p = computed(() => void 0 !== o.val && Array.isArray(o.modelValue)), v = computed(() => {
    ...
    return void 0 !== o.name && Object.assign(e2, { "^checked": true === m.value ? "checked" : void 0, name: o.name, value: true === p.value ? o.val : o.trueValue }), e2;
...
var QChip = createComponent({ name: "QChip", props: { ...useDarkProps, ...useSizeProps, dense: Boolean, icon: String, iconRight: String, iconRemove: String, iconSelected: String, label: [String, Number], color: String, textColor: String, modelValue: { type: Boolean, default: true }, selected: { type: Boolean, default: null }, square: Boolean, outline: Boolean, clickable: Boolean, removable: Boolean, removeAriaLabel: String, tabindex: [String, Number], disable: Boolean, ripple: { type: [Boolean, Object], default: true } }, emits: ["update:modelValue", "update:selected", "remove", "click"], setup(e, { slots: t, emit: o }) {
  const { proxy: { $q: n } } = getCurrentInstance(), a = useDark(e, n), l = useSize(e, defaultSizes$1), r = computed(() => true === e.selected || void 0 !== e.icon), i = computed(() => true === e.selected ? e.iconSelected || n.iconSet.chip.selected : e.icon), s = computed(() => e.iconRemove || n.iconSet.chip.remove), u = computed(() => false === e.disable && (true === e.clickable || null !== e.selected)), c = computed(() => {
    const t2 = true === e.outline && e.color || e.textColor;
...
var QCircularProgress = createComponent({ name: "QCircularProgress", props: { ...useCircularCommonProps, value: { type: Number, default: 0 }, animationSpeed: { type: [String, Number], default: 600 }, indeterminate: Boolean }, setup(e, { slots: t }) {
  ...
  }), l = computed(() => true !== e.instantFeedback && true !== e.indeterminate ? { transition: `stroke-dashoffset ${e.animationSpeed}ms ease 0s, stroke ${e.animationSpeed}ms ease` } : ""), r = computed(() => diameter / (1 - e.thickness / 2)), i = computed(() => `${r.value / 2} ${r.value / 2} ${r.value} ${r.value}`), s = computed(() => between(e.value, e.min, e.max)), u = computed(() => circumference * (1 - (s.value - e.min) / (e.max - e.min))), c = computed(() => e.thickness / 2 * r.value);
...
function useSlider({ updateValue: e, updatePosition: t, getDragging: o, formAttrs: n }) {
  ...
  function fe(e2, t2, o2, n2) {
    const l2 = [];
    "transparent" !== a.innerTrackColor && l2.push(h("div", { key: "inner", class: j.value, style: U.value })), "transparent" !== a.selectionColor && l2.push(h("div", { key: "selection", class: F.value, style: e2.value })), false !== a.markers && l2.push(h("div", { key: "marker", class: R.value, style: te.value })), n2(l2);
...
var QSlider = createComponent({ name: "QSlider", props: { ...useSliderProps, modelValue: { required: true, default: null, validator: (e) => "number" === typeof e || null === e }, labelValue: [String, Number] }, emits: useSliderEmits, setup(e, { emit: t }) {
  ...
  const u = computed(() => a.convertModelToRatio(i.value)), c = computed(() => true === n.active.value ? r.value : u.value), d = computed(() => {
  ...
  }), p = a.getThumbRenderFn({ focusValue: true, getNodeData, ratio: c, label: computed(() => void 0 !== e.labelValue ? e.labelValue : i.value), thumbColor: computed(() => e.thumbColor || e.color), labelColor: computed(() => e.labelColor), labelTextColor: computed(() => e.labelTextColor) }), v = computed(() => {
...
var QTabs = createComponent({ name: "QTabs", props: { modelValue: [Number, String], align: { type: String, default: "center", validator: (e) => alignValues$1.includes(e) }, breakpoint: { type: [String, Number], default: 600 }, vertical: Boolean, shrink: Boolean, stretch: Boolean, activeClass: String, activeColor: String, activeBgColor: String, indicatorColor: String, leftIcon: String, rightIcon: String, outsideArrows: Boolean, mobileArrows: Boolean, switchIndicator: Boolean, narrowIndicator: Boolean, inlineLabel: Boolean, noCaps: Boolean, dense: Boolean, contentClass: String, "onUpdate:modelValue": [Function, Array] }, setup(e, { slots: t, emit: o }) {
  ...
  function I() {
    ...
    if (null !== t2) {
      ...
      true === A.value ? (g.value = Math.ceil(n2 + o2.width) < t2.scrollWidth - 1, b.value = n2 > 0) : (g.value = n2 > 0, b.value = true === e.vertical ? Math.ceil(n2 + o2.height) < t2.scrollHeight : Math.ceil(n2 + o2.width) < t2.scrollWidth);
    }
  }
  function V(e2) {
    j(), _ = setInterval(() => {
  ...
  function N() {
    V(true === O.value ? Number.MAX_SAFE_INTEGER : 0);
  }
  function H() {
    V(true === O.value ? 0 : Number.MAX_SAFE_INTEGER);
  }
  function j() {
    clearInterval(_);
  }
  function U(t2, o2) {
    ...
    if (void 0 !== i2) {
      const e2 = true === A.value ? -1 : 1, t3 = n2.indexOf(o2) + i2 * e2;
      return t3 >= 0 && t3 < a2 && (z(n2[t3]), n2[t3].focus({ preventScroll: true })), true;
    }
  }
  watch(A, T), watch(() => e.modelValue, (e2) => {
    F({ name: e2, setCurrent: true, skipEmit: true });
  }), watch(() => e.outsideArrows, () => {
    R();
  }), watch(S, (e2) => {
    T = true === e2 ? I : noop, R();
  });
  const K = computed(() => true === O.value ? { get: (e2) => Math.abs(e2.scrollLeft), set: (e2, t2) => {
    e2.scrollLeft = -t2;
  ...
  function G() {
    ...
    for (const n2 of o2) {
      ...
      if (0 !== d2 && false === Y(s2, l2))
        continue;
      const p2 = { matchedLen: u2.length, queryDiff: r2 - d2, hrefLen: c2.length - i2.length };
    ...
    null === e2 && true === w.some((e3) => void 0 === e3.routeData && e3.name.value === m.value) || F({ name: e2, setCurrent: true });
  }
  function X(e2) {
    if (u(), true !== x.value && null !== p.value && e2.target && "function" === typeof e2.target.closest) {
      const t2 = e2.target.closest(".q-tab");
      t2 && true === p.value.contains(t2) && (x.value = true, true === f.value && z(t2));
    }
  }
  function Z() {
    s(() => {
  ...
  function te(e2) {
    w.push(e2), C.value++, R(), void 0 === e2.routeData || void 0 === n.$route ? c(() => {
      if (true === f.value) {
  ...
  const ne = { currentModel: m, tabProps: P, hasFocus: x, hasActiveTab: $, registerTab: te, unregisterTab: oe, verifyRouteModel: J, updateModel: F, onKbdNavigate: U, avoidRouteWatcher: false };
  function ae() {
...
function useTab(e, t, o, n) {
  ...
  function g() {
    ...
    const i2 = [h("div", { class: "q-focus-helper", tabindex: -1, ref: r }), h("div", { class: p.value }, hMergeSlot(t.default, n2))];
    return false === o2 && i2.push(l2), i2;
  }
  const b = { name: computed(() => e.name), rootRef: i, tabIndicatorRef: s, routeData: n };
  function y(t2, o2) {
...
var QTabPanels = createComponent({ name: "QTabPanels", props: { ...usePanelProps, ...useDarkProps }, emits: usePanelEmits, setup(e, { slots: t }) {
  const o = getCurrentInstance(), n = useDark(e, o.proxy.$q), { updatePanelsList: a, getPanelContent: l, panelDirectives: r } = usePanel(), i = computed(() => "q-tab-panels q-panel-parent" + (true === n.value ? " q-tab-panels--dark q-dark" : ""));
  return () => {
...
function lighten(e, t) {
  ...
  const o = textToRgb(e), n = t < 0 ? 0 : 255, a = Math.abs(t) / 100, l = o.r, r = o.g, i = o.b;
  return "#" + (16777216 + 65536 * (Math.round((n - l) * a) + l) + 256 * (Math.round((n - r) * a) + r) + (Math.round((n - i) * a) + i)).toString(16).slice(1);
}
...
function blend(e, t) {
  ...
  const o = "string" === typeof e ? textToRgb(e) : e, n = o.r / 255, a = o.g / 255, l = o.b / 255, r = void 0 !== o.a ? o.a / 100 : 1, i = "string" === typeof t ? textToRgb(t) : t, s = i.r / 255, u = i.g / 255, c = i.b / 255, d = void 0 !== i.a ? i.a / 100 : 1, p = r + d * (1 - r), v = Math.round((n * r + s * d * (1 - r)) / p * 255), m = Math.round((a * r + u * d * (1 - r)) / p * 255), f = Math.round((l * r + c * d * (1 - r)) / p * 255), h2 = { r: v, g: m, b: f, a: Math.round(100 * p) };
...
function changeAlpha(e, t) {
  ...
  const { r: o, g: n, b: a, a: l } = textToRgb(e), r = void 0 !== l ? l / 100 : 0;
  return rgbToHex({ r: o, g: n, b: a, a: Math.round(100 * Math.min(1, Math.max(0, r + t))) });
}
...
var QColor = createComponent({ name: "QColor", props: { ...useDarkProps, ...useFormProps, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  ...
  function M(e2, t2, o2) {
    ...
    const c2 = Math.min(i2, Math.max(0, t2 - s2.top)), d2 = Math.round(100 * u2 / l2), v2 = Math.round(100 * Math.max(0, Math.min(1, -c2 / i2 + 1))), m2 = hsvToRgb({ h: p.value.h, s: d2, v: v2, a: true === y.value ? p.value.a : void 0 });
  ...
  function Q(e2, t2, n2, a2, l2) {
    ...
    if (r2 < 0 || r2 > n2)
      return void (true === l2 && o.$forceUpdate());
    const i2 = { r: "r" === t2 ? r2 : p.value.r, g: "g" === t2 ? r2 : p.value.g, b: "b" === t2 ? r2 : p.value.b, a: true === y.value ? "a" === t2 ? r2 : p.value.a : void 0 };
    if ("a" !== t2) {
  ...
  function N() {
    const e2 = { ref: r, class: "q-color-picker__spectrum non-selectable relative-position cursor-pointer" + (true !== v.value ? " readonly" : ""), style: C.value, ...true === v.value ? { onClick: R, onMousedown: L } : {} }, t2 = [h("div", { style: { paddingBottom: "100%" } }), h("div", { class: "q-color-picker__spectrum-white absolute-full" }), h("div", { class: "q-color-picker__spectrum-black absolute-full" }), h("div", { class: "absolute", style: x.value }, [void 0 !== p.value.hex ? h("div", { class: "q-color-picker__spectrum-circle" }) : null])], o2 = [h(QSlider, { class: "q-color-picker__hue non-selectable", modelValue: p.value.h, min: 0, max: 360, trackSize: "8px", innerTrackColor: "transparent", selectionColor: "transparent", readonly: true !== v.value, thumbPath, "onUpdate:modelValue": B, ...l("lazyhue", { onChange: (e3) => B(e3, true) }) })];
  ...
  function H() {
    return [h("div", { class: "row items-center no-wrap" }, [h("div", "R"), h(QSlider, { modelValue: p.value.r, min: 0, max: 255, color: "red", dark: a.value, readonly: true !== v.value, ...l("rSlide", { "onUpdate:modelValue": (e2) => Q(e2, "r", 255), onChange: (e2) => Q(e2, "r", 255, void 0, true) }) }), h("input", { value: p.value.r, maxlength: 3, readonly: true !== v.value, onChange: stop, ...l("rIn", { onInput: (e2) => Q(e2.target.value, "r", 255, e2), onBlur: (e2) => Q(e2.target.value, "r", 255, e2, true) }) })]), h("div", { class: "row items-center no-wrap" }, [h("div", "G"), h(QSlider, { modelValue: p.value.g, min: 0, max: 255, color: "green", dark: a.value, readonly: true !== v.value, ...l("gSlide", { "onUpdate:modelValue": (e2) => Q(e2, "g", 255), onChange: (e2) => Q(e2, "g", 255, void 0, true) }) }), h("input", { value: p.value.g, maxlength: 3, readonly: true !== v.value, onChange: stop, ...l("gIn", { onInput: (e2) => Q(e2.target.value, "g", 255, e2), onBlur: (e2) => Q(e2.target.value, "g", 255, e2, true) }) })]), h("div", { class: "row items-center no-wrap" }, [h("div", "B"), h(QSlider, { modelValue: p.value.b, min: 0, max: 255, color: "blue", readonly: true !== v.value, dark: a.value, ...l("bSlide", { "onUpdate:modelValue": (e2) => Q(e2, "b", 255), onChange: (e2) => Q(e2, "b", 255, void 0, true) }) }), h("input", { value: p.value.b, maxlength: 3, readonly: true !== v.value, onChange: stop, ...l("bIn", { onInput: (e2) => Q(e2.target.value, "b", 255, e2), onBlur: (e2) => Q(e2.target.value, "b", 255, e2, true) }) })]), true === y.value ? h("div", { class: "row items-center no-wrap" }, [h("div", "A"), h(QSlider, { modelValue: p.value.a, color: "grey", readonly: true !== v.value, dark: a.value, ...l("aSlide", { "onUpdate:modelValue": (e2) => Q(e2, "a", 100), onChange: (e2) => Q(e2, "a", 100, void 0, true) }) }), h("input", { value: p.value.a, maxlength: 3, readonly: true !== v.value, onChange: stop, ...l("aIn", { onInput: (e2) => Q(e2.target.value, "a", 100, e2), onBlur: (e2) => Q(e2.target.value, "a", 100, e2, true) }) })]) : null];
  }
  function j() {
...
function jalCal(e, t) {
  ...
  return t || (l - i < 6 && (i = i - l + 33 * div(l + 4, 33)), r = mod(mod(i + 1, 33) - 1, 4), -1 === r && (r = 4)), { leap: r, gy: n, march: p };
}
function j2d(e, t, o) {
...
function applyYearMonthDay(e, t, o) {
  const n = void 0 !== t.year ? t.year : e[`get${o}FullYear`](), a = void 0 !== t.month ? t.month - 1 : e[`get${o}Month`](), l = new Date(n, a + 1, 0).getDate(), r = Math.min(l, void 0 !== t.date ? t.date : e[`get${o}Date`]());
  return e[`set${o}Date`](1), e[`set${o}Month`](2), e[`set${o}FullYear`](n), e[`set${o}Month`](a), e[`set${o}Date`](r), delete t.year, delete t.month, delete t.date, e;
}
function getChange(e, t, o) {
  ...
  for (const r in n) {
    const e2 = capitalize(r);
    l[`set${e2}`](l[`get${e2}`]() + o * n[r]);
  }
  return l;
}
...
function adjustDate(e, t, o) {
  const n = normalizeMod(t), a = true === o ? "UTC" : "", l = new Date(e), r = void 0 !== n.year || void 0 !== n.month || void 0 !== n.date ? applyYearMonthDay(l, n, a) : l;
  for (const i in n) {
    const e2 = i.charAt(0).toUpperCase() + i.slice(1);
    r[`set${a}${e2}`](n[i]);
  }
  return r;
}
...
function isBetweenDates(e, t, o, n = {}) {
  const a = getDateIdentifier(t, n.onlyDate), l = getDateIdentifier(o, n.onlyDate), r = getDateIdentifier(e, n.onlyDate);
  return (r > a || true === n.inclusiveFrom && r === a) && (r < l || true === n.inclusiveTo && r === l);
}
...
var QDate = createComponent({ name: "QDate", props: { ...useDatetimeProps, ...useFormProps, ...useDarkProps, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: yearMonthValidator }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: yearMonthValidator }, navigationMaxYearMonth: { type: String, validator: yearMonthValidator }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: viewIsValid } }, emits: [...useDatetimeEmits, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: o }) {
  ...
  const p = useFormAttrs(e), v = useFormInject(p), m = ref(null), f = ref(de()), g = ref(u()), b = computed(() => de()), y = computed(() => u()), S = computed(() => c()), w = ref(ve(f.value, g.value)), C = ref(e.defaultView), x = true === a.lang.rtl ? "right" : "left", k = ref(x.value), _ = ref(x.value), q = w.value.year, T = ref(q - q % yearsInterval - (q < 0 ? yearsInterval : 0)), P = ref(null), $ = computed(() => {
  ...
  }), Q = computed(() => true === e.emitImmediately && true !== e.multiple && true !== e.range), E = computed(() => true === Array.isArray(e.modelValue) ? e.modelValue : null !== e.modelValue && void 0 !== e.modelValue ? [e.modelValue] : []), A = computed(() => E.value.filter((e2) => "string" === typeof e2).map((e2) => pe(e2, f.value, g.value)).filter((e2) => null !== e2.dateHash && null !== e2.day && null !== e2.month && null !== e2.year)), O = computed(() => {
  ...
  }), F = computed(() => "persian" !== e.calendar ? (e2) => new Date(e2.year, e2.month - 1, e2.day) : (e2) => {
    const t2 = toGregorian(e2.year, e2.month, e2.day);
    return new Date(t2.gy, t2.gm - 1, t2.gd);
  }), R = computed(() => "persian" === e.calendar ? getDayHash : (e2, t2, o2) => formatDate(new Date(e2.year, e2.month - 1, e2.day, e2.hour, e2.minute, e2.second, e2.millisecond), void 0 === t2 ? f.value : t2, void 0 === o2 ? g.value : o2, e2.year, e2.timezoneOffset)), L = computed(() => A.value.length + O.value.reduce((e2, t2) => e2 + 1 + getDateDiff(F.value(t2.to), F.value(t2.from)), 0)), D = computed(() => {
    ...
    const t2 = A.value[0], o2 = F.value(t2);
...
var QDialog = createComponent({ name: "QDialog", inheritAttrs: false, props: { ...useModelToggleProps, ...useTransitionProps, transitionShow: String, transitionHide: String, persistent: Boolean, autoClose: Boolean, allowFocusOutside: Boolean, noEscDismiss: Boolean, noBackdropDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, noShake: Boolean, seamless: Boolean, maximized: Boolean, fullWidth: Boolean, fullHeight: Boolean, square: Boolean, position: { type: String, default: "standard", validator: (e) => "standard" === e || ["top", "bottom", "left", "right"].includes(e) } }, emits: [...useModelToggleEmits, "shake", "click", "escapeKey"], setup(e, { slots: t, emit: o, attrs: n }) {
  const a = getCurrentInstance(), l = ref(null), r = ref(false), i = ref(false);
  let s, u, c, d = null;
  const p = computed(() => true !== e.persistent && true !== e.noRouteDismiss && true !== e.seamless), { preventBodyScroll: v } = usePreventScroll(), { registerTimeout: m } = useTimeout(), { registerTick: f, removeTick: g } = useTick(), { transitionProps: b, transitionStyle: y } = useTransition(e, () => defaultTransitions[e.position][0], () => defaultTransitions[e.position][1]), { showPortal: S, hidePortal: w, portalIsAccessible: C, renderPortal: x } = usePortal(a, l, I, true), { hide: k } = useModelToggle({ showing: r, hideOnRouteChange: p, handleShow: B, handleHide: Q, processOnMount: true }), { addToHistory: _, removeFromHistory: q } = useHistory(r, k, p), T = computed(() => `q-dialog__inner flex no-pointer-events q-dialog__inner--${true === e.maximized ? "maximized" : "minimized"} q-dialog__inner--${e.position} ${positionClass$1[e.position]}` + (true === i.value ? " q-dialog__inner--animating" : "") + (true === e.fullWidth ? " q-dialog__inner--fullwidth" : "") + (true === e.fullHeight ? " q-dialog__inner--fullheight" : "") + (true === e.square ? " q-dialog__inner--square" : "")), P = computed(() => true === r.value && true !== e.seamless), $ = computed(() => true === e.autoClose ? { onClick: L } : {}), M = computed(() => [`q-dialog fullscreen no-pointer-events q-dialog--${true === P.value ? "modal" : "seamless"}`, n.class]);
  function B(t2) {
    _(), d = false === e.noRefocus && null !== document.activeElement ? document.activeElement : null, R(e.maximized), S(), i.value = true, true !== e.noFocus ? (null !== document.activeElement && document.activeElement.blur(), f(E)) : g(), m(() => {
      if (true === a.proxy.$q.platform.is.ios) {
        ...
        c = true, l.value.click(), c = false;
      }
      S(true), i.value = false, o("show", t2);
    }, e.transitionDuration);
  }
  function Q(t2) {
    g(), q(), F(true), i.value = true, w(), null !== d && (d.focus(), d = null), m(() => {
      w(true), i.value = false, o("hide", t2);
    }, e.transitionDuration);
  }
  function E(e2) {
    addFocusFn(() => {
  ...
  function A(e2) {
    e2 && "function" === typeof e2.focus ? e2.focus({ preventScroll: true }) : E(), o("shake");
    const t2 = l.value;
    null !== t2 && (t2.classList.remove("q-animate--scale"), t2.classList.add("q-animate--scale"), clearTimeout(s), s = setTimeout(() => {
      null !== l.value && (t2.classList.remove("q-animate--scale"), E());
    }, 170));
  }
  function O() {
  ...
  function F(t2) {
    clearTimeout(s), true !== t2 && true !== r.value || (R(false), true !== e.seamless && (v(false), removeFocusout(z), removeEscapeKey(O))), true !== t2 && (d = null);
  }
  function R(e2) {
    true === e2 ? true !== u && (maximizedModals < 1 && document.body.classList.add("q-body--dialog"), maximizedModals++, u = true) : true === u && (maximizedModals < 2 && document.body.classList.remove("q-body--dialog"), maximizedModals--, u = false);
  }
  function L(e2) {
    true !== c && (k(e2), o("click", e2));
  }
  function D(t2) {
    true !== e.persistent && true !== e.noBackdropDismiss ? k(t2) : true !== e.noShake && A(t2.relatedTarget);
  }
  function z(t2) {
    true !== e.allowFocusOutside && true === C.value && true !== childHasFocus(l.value, t2.target) && E('[tabindex]:not([tabindex="-1"])');
  }
  function I() {
    return h("div", { role: "dialog", "aria-modal": true === P.value ? "true" : "false", ...n, class: M.value }, [h(Transition, { name: "q-transition--fade", appear: true }, () => true === P.value ? h("div", { class: "q-dialog__backdrop fixed-full", style: y.value, "aria-hidden": "true", tabindex: -1, onFocusin: D }) : null), h(Transition, b.value, () => true === r.value ? h("div", { ref: l, class: T.value, style: y.value, tabindex: -1, ...$.value }, hSlot(t.default)) : null)]);
  }
  return watch(() => e.maximized, (e2) => {
    true === r.value && R(e2);
  }), watch(P, (e2) => {
    v(e2), true === e2 ? (addFocusout(z), addEscapeKey(O)) : (removeFocusout(z), removeEscapeKey(O));
  }), Object.assign(a.proxy, { focus: E, shake: A, __updateRefocusTarget(e2) {
    d = e2 || null;
  } }), onBeforeUnmount(F), x;
} });
var duration = 150;
var QDrawer = createComponent({ name: "QDrawer", inheritAttrs: false, props: { ...useModelToggleProps, ...useDarkProps, side: { type: String, default: "left", validator: (e) => ["left", "right"].includes(e) }, width: { type: Number, default: 300 }, mini: Boolean, miniToOverlay: Boolean, miniWidth: { type: Number, default: 57 }, breakpoint: { type: Number, default: 1023 }, showIfAbove: Boolean, behavior: { type: String, validator: (e) => ["default", "desktop", "mobile"].includes(e), default: "default" }, bordered: Boolean, elevated: Boolean, overlay: Boolean, persistent: Boolean, noSwipeOpen: Boolean, noSwipeClose: Boolean, noSwipeBackdrop: Boolean }, emits: [...useModelToggleEmits, "onLayout", "miniState"], setup(e, { slots: t, emit: o, attrs: n }) {
  ...
  }), H = computed(() => "q-drawer__content fit " + (true !== c.isContainer.value ? "scroll" : "overflow-auto")), j = computed(() => `q-drawer q-drawer--${e.side}` + (true === B.value ? " q-drawer--mini-animate" : "") + (true === e.bordered ? " q-drawer--bordered" : "") + (true === r.value ? " q-drawer--dark q-dark" : "") + (true === M.value ? " no-transition" : true === b.value ? "" : " q-layout--prevent-focus") + (true === m.value ? " fixed q-drawer--on-top q-drawer--mobile q-drawer--top-padding" : ` q-drawer--${true === f.value ? "mini" : "standard"}` + (true === O.value || true !== F.value ? " fixed" : "") + (true === e.overlay || true === e.miniToOverlay ? " q-drawer--on-top" : "") + (true === z.value ? " q-drawer--top-padding" : ""))), U = computed(() => {
  ...
  function J() {
    clearTimeout(p), a.proxy && a.proxy.$el && a.proxy.$el.classList.add("q-drawer--mini-animate"), B.value = true, p = setTimeout(() => {
  ...
  return watch(m, (t2) => {
    ...
    c.instances[t2] === q && (c.instances[t2] = void 0, c[t2].space = false, c[t2].offset = 0), c.instances[e2] = q, c[e2].size = g.value, c[e2].space = F.value, c[e2].offset = A.value;
  }), watch(c.totalWidth, () => {
    ...
    o("miniState", e2);
  }), c.instances[e.side] = q, le(e.miniToOverlay, g.value), ne("space", F.value), ne("offset", A.value), true === e.showIfAbove && true !== e.modelValue && true === b.value && void 0 !== e["onUpdate:modelValue"] && o("update:modelValue", true), onMounted(() => {
    o("onLayout", F.value), o("miniState", f.value), d = true === e.showIfAbove;
    const t2 = () => {
    ...
    void 0 !== v && v(), clearTimeout(p), true === b.value && oe(), c.instances[e.side] === q && (c.instances[e.side] = void 0, ne("size", 0), ne("offset", 0), ne("space", false));
  }), () => {
    const o2 = [];
...
var QTooltip = createComponent({ name: "QTooltip", inheritAttrs: false, props: { ...useAnchorProps, ...useModelToggleProps, ...useTransitionProps, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null }, transitionShow: { default: "jump-down" }, transitionHide: { default: "jump-up" }, anchor: { type: String, default: "bottom middle", validator: validatePosition }, self: { type: String, default: "top middle", validator: validatePosition }, offset: { type: Array, default: () => [14, 14], validator: validateOffset }, scrollTarget: { default: void 0 }, delay: { type: Number, default: 0 }, hideDelay: { type: Number, default: 0 } }, emits: [...useModelToggleEmits], setup(e, { slots: t, emit: o, attrs: n }) {
  let a, l;
  const r = getCurrentInstance(), { proxy: { $q: i } } = r, s = ref(null), u = ref(false), c = computed(() => parsePosition(e.anchor, i.lang.rtl)), d = computed(() => parsePosition(e.self, i.lang.rtl)), p = computed(() => true !== e.persistent), { registerTick: v, removeTick: m } = useTick(), { registerTimeout: f } = useTimeout(), { transitionProps: g, transitionStyle: b } = useTransition(e), { localScrollTarget: y, changeScrollEvent: S, unconfigureScrollTarget: w } = useScrollTarget(e, R), { anchorEl: C, canShow: x, anchorEvents: k } = useAnchor({ showing: u, configureAnchorEl: F }), { show: _, hide: q } = useModelToggle({ showing: u, canShow: x, handleShow: M, handleHide: B, hideOnRouteChange: p, processOnMount: true });
...
var QItem = createComponent({ name: "QItem", props: { ...useDarkProps, ...useRouterLinkProps, tag: { type: String, default: "div" }, active: { type: Boolean, default: null }, clickable: Boolean, dense: Boolean, insetLevel: Number, tabindex: [String, Number], focused: Boolean, manualFocus: Boolean }, emits: ["click", "keyup"], setup(e, { slots: t, emit: o }) {
  const { proxy: { $q: n } } = getCurrentInstance(), a = useDark(e, n), { hasLink: l, linkAttrs: r, linkClass: i, linkTag: s, navigateOnClick: u } = useRouterLink(), c = ref(null), d = ref(null), p = computed(() => true === e.clickable || true === l.value || "label" === e.tag), v = computed(() => true !== e.disable && true === p.value), m = computed(() => "q-item q-item-type row no-wrap" + (true === e.dense ? " q-item--dense" : "") + (true === a.value ? " q-item--dark" : "") + (true === l.value && null === e.active ? i.value : true === e.active ? ` q-item--active${void 0 !== e.activeClass ? ` ${e.activeClass}` : ""}` : "") + (true === e.disable ? " disabled" : "") + (true === v.value ? " q-item--clickable q-link cursor-pointer " + (true === e.manualFocus ? "q-manual-focusable" : "q-focusable q-hoverable") + (true === e.focused ? " q-manual-focusable--focused" : "") : "")), f = computed(() => {
  ...
  return () => {
    ...
    return true === v.value ? (t2.tabindex = e.tabindex || "0", Object.assign(t2, r.value)) : true === p.value && (t2["aria-disabled"] = "true"), h(s.value, t2, y());
  };
} });
...
function extend() {
  ...
  for ("boolean" === typeof r && (s = r, r = arguments[1] || {}, i = 2), Object(r) !== r && "function" !== typeof r && (r = {}), u === i && (r = this, i--); i < u; i++)
    if (null !== (e = arguments[i]))
      for (t in e)
        o = r[t], n = e[t], r !== n && (true === s && n && ((a = Array.isArray(n)) || true === isPlainObject(n)) ? (l = true === a ? true === Array.isArray(o) ? o : [] : true === isPlainObject(o) ? o : {}, r[t] = extend(s, l, n)) : void 0 !== n && (r[t] = n));
  return r;
}
var QEditor = createComponent({ name: "QEditor", props: { ...useDarkProps, ...useFullscreenProps, modelValue: { type: String, required: true }, readonly: Boolean, disable: Boolean, minHeight: { type: String, default: "10rem" }, maxHeight: String, height: String, definitions: Object, fonts: Object, placeholder: String, toolbar: { type: Array, validator: (e) => 0 === e.length || e.every((e2) => e2.length), default() {
  ...
  const { proxy: a, vnode: l } = getCurrentInstance(), { $q: r } = a, i = useDark(e, r), { inFullscreen: s, toggleFullscreen: u } = useFullscreen(), c = useSplitAttrs(n, l), d = ref(null), p = ref(null), v = ref(null), m = ref(false), f = computed(() => !e.readonly && !e.disable);
  ...
  const S = computed(() => e.toolbarBg ? ` bg-${e.toolbarBg}` : ""), w = computed(() => {
    ...
    const t2 = e.definitions || {}, o2 = e.definitions || e.fonts ? extend(true, {}, C.value, t2, getFonts(g, r.lang.editor.defaultFont, r.iconSet.editor.font, e.fonts)) : C.value;
  ...
  }), k = { $q: r, props: e, slots: t, inFullscreen: s, toggleFullscreen: u, runCmd: I, isViewingSource: m, editLinkUrl: v, toolbarBackgroundClass: S, buttonProps: w, contentRef: p, buttons: x, setContent: z };
  watch(() => e.modelValue, (e2) => {
    y !== e2 && (y = e2, z(e2, true));
  });
  ...
  return onMounted(() => {
    ...
    return h("div", { ref: d, class: P.value, style: { height: true === s.value ? "100%" : null }, ...M.value, onFocusin: F, onFocusout: R }, [t2, h("div", { ref: p, style: T.value, class: $.value, contenteditable: f.value, placeholder: e.placeholder, ...{}, ...c.listeners.value, onInput: B, onKeydown: Q, onClick: E, onBlur: A, onFocus: O, onMousedown: L, onTouchstartPassive: L })]);
  };
} });
  ...
  function v(t2, o2) {
    ...
    a = t2, true === u ? (c(), n2 = t2.offsetHeight === t2.scrollHeight ? 0 : void 0) : s = "hide", d(t2, n2, o2), l = setTimeout(() => {
      t2.style.height = `${t2.scrollHeight}px`, i = (e2) => {
        Object(e2) === e2 && e2.target !== t2 || p(t2, "show");
  ...
  function m(t2, o2) {
    ...
    a = t2, true === u ? c() : (s = "show", n2 = t2.scrollHeight), d(t2, n2, o2), l = setTimeout(() => {
      t2.style.height = 0, i = (e2) => {
        Object(e2) === e2 && e2.target !== t2 || p(t2, "hide");
      }, t2.addEventListener("transitionend", i), r = setTimeout(i, 1.1 * e.duration);
    }, 100);
  }
  return onBeforeUnmount(() => {
...
var QSeparator = createComponent({ name: "QSeparator", props: { ...useDarkProps, spaced: [Boolean, String], inset: [Boolean, String], vertical: Boolean, color: String, size: String }, setup(e) {
  const t = getCurrentInstance(), o = useDark(e, t.proxy.$q), n = computed(() => true === e.vertical ? "vertical" : "horizontal"), a = computed(() => ` q-separator--${n.value}`), l = computed(() => false !== e.inset ? `${a.value}-${insetMap[e.inset]}` : ""), r = computed(() => `q-separator${a.value}${l.value}` + (void 0 !== e.color ? ` bg-${e.color}` : "") + (true === o.value ? " q-separator--dark" : "")), i = computed(() => {
    const t2 = {};
...
var QFab = createComponent({ name: "QFab", props: { ...useFabProps, ...useModelToggleProps, icon: String, activeIcon: String, hideIcon: Boolean, hideLabel: { default: null }, direction: { type: String, default: "right", validator: (e) => directions.includes(e) }, persistent: Boolean, verticalActionsAlign: { type: String, default: "center", validator: (e) => alignValues.includes(e) } }, emits: useModelToggleEmits, setup(e, { slots: t }) {
  const o = ref(null), n = ref(true === e.modelValue), a = uid$3(), { proxy: { $q: l } } = getCurrentInstance(), { formClass: r, labelProps: i } = useFab(e, n), s = computed(() => true !== e.persistent), { hide: u, toggle: c } = useModelToggle({ showing: n, hideOnRouteChange: s }), d = computed(() => ({ opened: n.value })), p = computed(() => `q-fab z-fab row inline justify-center q-fab--align-${e.verticalActionsAlign} ${r.value}` + (true === n.value ? " q-fab--opened" : " q-fab--closed")), v = computed(() => `q-fab__actions flex no-wrap inline q-fab__actions--${e.direction} q-fab__actions--${true === n.value ? "opened" : "closed"}`), m = computed(() => {
    const e2 = { id: a };
  ...
  } }), () => h("div", { class: p.value }, [h(QBtn, { ref: o, class: r.value, ...e, noWrap: true, stack: e.stacked, align: void 0, icon: void 0, label: void 0, noCaps: true, fab: true, "aria-expanded": true === n.value ? "true" : "false", "aria-haspopup": "true", "aria-controls": a, "aria-owns": a, onClick: c }, b), h("div", { class: v.value, ...m.value }, hSlot(t.default))]);
} });
...
var QFabAction = createComponent({ name: "QFabAction", props: { ...useFabProps, icon: { type: String, default: "" }, anchor: { type: String, validator: (e) => anchorValues.includes(e) }, to: [String, Object], replace: Boolean }, emits: ["click"], setup(e, { slots: t, emit: o }) {
  const n = inject(fabKey, () => ({ showing: { value: true }, onChildClick: noop })), { formClass: a, labelProps: l } = useFab(e, n.showing), r = computed(() => {
    const t2 = anchorMap[e.anchor];
    return a.value + (void 0 !== t2 ? ` ${t2}` : "");
  }), i = computed(() => true === e.disable || true !== n.showing.value);
  function s(e2) {
...
function useValidate(e, t) {
  ...
  }), Object.assign(n, { resetValidation: v, validate: m }), injectProp(n, "hasError", () => d.value), { isDirtyModel: r, hasRules: u, hasError: d, errorMessage: p, validate: m, resetValidation: v };
}
...
function useField(e) {
  ...
  function P(n2) {
    ...
    "file" === t.type && (e.inputRef.value.value = null), o("update:modelValue", null), o("clear", t.modelValue), nextTick(() => {
      p(), true !== r.platform.is.mobile && (s.value = false);
    });
  }
  function $() {
    const o2 = [];
...
function useFile({ editable: e, dnd: t, getFileInput: o, addFilesToQueue: n }) {
  const { props: a, emit: l, proxy: r } = getCurrentInstance(), i = ref(null), s = computed(() => void 0 !== a.accept ? a.accept.split(",").map((e2) => {
  ...
  return Object.assign(r, { pickFiles: d, addFiles: p }), { pickFiles: d, addFiles: p, onDragover: m, onDragleave: f, processFiles: v, getDndNode: b, maxFilesNumber: u, maxTotalSizeNumber: c };
}
...
var QFile = createComponent({ name: "QFile", inheritAttrs: false, props: { ...useFieldProps, ...useFormProps, ...useFileProps, modelValue: [File, FileList, Array], append: Boolean, useChips: Boolean, displayValue: [String, Number], tabindex: { type: [String, Number], default: 0 }, counterLabel: Function, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...useFieldEmits, ...useFileEmits], setup(e, { slots: t, emit: o, attrs: n }) {
  const { proxy: a } = getCurrentInstance(), l = useFieldState(), r = ref(null), i = ref(false), s = useFormInputNameAttr(e), { pickFiles: u, onDragover: c, onDragleave: d, processFiles: p, getDndNode: v } = useFile({ editable: l.editable, dnd: i, getFileInput: $, addFilesToQueue: M }), m = useFileFormDomProps(e), f = computed(() => Object(e.modelValue) === e.modelValue ? "length" in e.modelValue ? Array.from(e.modelValue) : [e.modelValue] : []), g = computed(() => fieldValueIsFilled(f.value)), b = computed(() => f.value.map((e2) => e2.name).join(", ")), y = computed(() => humanStorageSize(f.value.reduce((e2, t2) => e2 + t2.size, 0))), S = computed(() => ({ totalSize: y.value, filesNumber: f.value.length, maxFiles: e.maxFiles })), w = computed(() => ({ tabindex: -1, type: "file", title: "", accept: e.accept, capture: e.capture, name: s.value, ...n, id: l.targetUid.value, disabled: true !== l.editable.value })), C = computed(() => "q-file q-field--auto-height" + (true === i.value ? " q-file--dnd" : "")), x = computed(() => true === e.multiple && true === e.append);
  function k(e2) {
  ...
  return Object.assign(l, { fieldClass: C, emitValue: q, hasValue: g, inputRef: r, innerValue: f, floatingLabel: computed(() => true === g.value || fieldValueIsFilled(e.displayValue)), computedCounter: computed(() => {
  ...
  } }), Object.assign(a, { removeAtIndex: k, removeFile: _, getNativeElement: () => r.value }), injectProp(a, "nativeEl", () => r.value), useField(l);
} });
var QFooter = createComponent({ name: "QFooter", props: { modelValue: { type: Boolean, default: true }, reveal: Boolean, bordered: Boolean, elevated: Boolean, heightHint: { type: [String, Number], default: 50 } }, emits: ["reveal", "focusin"], setup(e, { slots: t, emit: o }) {
  ...
  const l = ref(parseInt(e.heightHint, 10)), r = ref(true), i = ref(true === isRuntimeSsrPreHydration.value || true === a.isContainer.value ? 0 : window.innerHeight), s = computed(() => true === e.reveal || a.view.value.indexOf("F") > -1 || n.platform.is.ios && true === a.isContainer.value), u = computed(() => true === a.isContainer.value ? a.containerHeight.value : i.value), c = computed(() => {
  ...
  function S(e2) {
    true === p.value && g(r, true), o("focusin", e2);
  }
  watch(() => e.modelValue, (e2) => {
...
var QHeader = createComponent({ name: "QHeader", props: { modelValue: { type: Boolean, default: true }, reveal: Boolean, revealOffset: { type: Number, default: 250 }, bordered: Boolean, elevated: Boolean, heightHint: { type: [String, Number], default: 50 } }, emits: ["reveal", "focusin"], setup(e, { slots: t, emit: o }) {
  ...
  const l = ref(parseInt(e.heightHint, 10)), r = ref(true), i = computed(() => true === e.reveal || a.view.value.indexOf("H") > -1 || n.platform.is.ios && true === a.isContainer.value), s = computed(() => {
    if (true !== e.modelValue)
      return 0;
    if (true === i.value)
      return true === r.value ? l.value : 0;
    ...
    return t2 > 0 ? t2 : 0;
  }), u = computed(() => true !== e.modelValue || true === i.value && true !== r.value), c = computed(() => true === e.modelValue && true === u.value && true === e.reveal), d = computed(() => "q-header q-layout__section--marginal " + (true === i.value ? "fixed" : "absolute") + "-top" + (true === e.bordered ? " q-header--bordered" : "") + (true === u.value ? " q-header--hidden" : "") + (true !== e.modelValue ? " q-layout--prevent-focus" : "")), p = computed(() => {
...
var QImg = createComponent({ name: "QImg", props: { ...useRatioProps, src: String, srcset: String, sizes: String, alt: String, crossorigin: String, decoding: String, referrerpolicy: String, draggable: Boolean, loading: { type: String, default: "lazy" }, fetchpriority: { type: String, default: "auto" }, width: String, height: String, initialRatio: { type: [Number, String], default: defaultRatio }, placeholderSrc: String, fit: { type: String, default: "cover" }, position: { type: String, default: "50% 50%" }, imgClass: String, imgStyle: Object, noSpinner: Boolean, noNativeMenu: Boolean, noTransition: Boolean, spinnerColor: String, spinnerSize: String }, emits: ["load", "error"], setup(e, { slots: t, emit: o }) {
  ...
  let l;
  const r = [ref(null), ref(void 0 !== e.placeholderSrc ? { src: e.placeholderSrc } : null)], i = ref(0), s = ref(false), u = ref(false), c = computed(() => `q-img q-img--${true === e.noNativeMenu ? "no-" : ""}menu`), d = computed(() => ({ width: e.width, height: e.height })), p = computed(() => `q-img__image ${void 0 !== e.imgClass ? e.imgClass + " " : ""}q-img__image--with${true === e.noTransition ? "out" : ""}-transition`), v = computed(() => ({ ...e.imgStyle, objectFit: e.fit, objectPosition: e.position }));
  function m() {
  ...
  function C(t2) {
    const o2 = r[t2].value, n2 = { key: "img_" + t2, class: p.value, style: v.value, crossorigin: e.crossorigin, decoding: e.decoding, referrerpolicy: e.referrerpolicy, height: e.height, width: e.width, loading: e.loading, fetchpriority: e.fetchpriority, "aria-hidden": "true", draggable: e.draggable, ...o2 };
...
var QInfiniteScroll = createComponent({ name: "QInfiniteScroll", props: { offset: { type: Number, default: 500 }, debounce: { type: [String, Number], default: 100 }, scrollTarget: { default: void 0 }, initialIndex: Number, disable: Boolean, reverse: Boolean }, emits: ["load"], setup(e, { slots: t, emit: o }) {
  ...
  return Object.assign(S.proxy, { poll: () => {
    void 0 !== i && i();
  }, trigger: d, stop: m, reset: p, resume: v, setIndex: g }), () => {
    const o2 = hUniqueSlot(t.default, []);
...
var QInnerLoading = createComponent({ name: "QInnerLoading", props: { ...useDarkProps, ...useTransitionProps, showing: Boolean, color: String, size: { type: [String, Number], default: 42 }, label: String, labelClass: String, labelStyle: [String, Array, Object] }, setup(e, { slots: t }) {
  const o = getCurrentInstance(), n = useDark(e, o.proxy.$q), { transitionProps: a, transitionStyle: l } = useTransition(e), r = computed(() => "q-inner-loading absolute-full column flex-center" + (true === n.value ? " q-inner-loading--dark" : "")), i = computed(() => "q-inner-loading__label" + (void 0 !== e.labelClass ? ` ${e.labelClass}` : ""));
  function s() {
...
function useMask(e, t, o, n) {
  ...
  function v() {
    ...
    const t2 = void 0 === NAMED_MASKS[e.mask] ? e.mask : NAMED_MASKS[e.mask], o2 = "string" === typeof e.fillMask && e.fillMask.length > 0 ? e.fillMask.slice(0, 1) : "_", n2 = o2.replace(escRegex, "\\$&"), u2 = [], d2 = [], p2 = [];
    let v2 = true === e.reverseFillMask, m2 = "", f2 = "";
    t2.replace(tokenRegexMask, (e2, t3, o3, n3, a2) => {
      if (void 0 !== n3) {
        const e3 = TOKENS[n3];
        p2.push(e3), f2 = e3.negate, true === v2 && (d2.push("(?:" + f2 + "+)?(" + e3.pattern + "+)?(?:" + f2 + "+)?(" + e3.pattern + "+)?"), v2 = false), d2.push("(?:" + f2 + "+)?(" + e3.pattern + ")?");
      } else if (void 0 !== o3)
        m2 = "\\" + ("\\" === o3 ? "" : o3), p2.push(o3), u2.push("([^" + m2 + "]+)?" + m2 + "?");
      else {
        const e3 = void 0 !== t3 ? t3 : a2;
        m2 = "\\" === e3 ? "\\\\\\\\" : e3.replace(escRegex, "\\\\$&"), p2.push(e3), u2.push("([^" + m2 + "]+)?" + m2 + "?");
      }
    });
    ...
    r = p2, i = (t3) => {
      const o3 = h3.exec(true === e.reverseFillMask ? t3 : t3.slice(0, p2.length));
    ...
    }, a = p2.map((e2) => "string" === typeof e2 ? e2 : MARKER).join(""), l = a.split(MARKER).join(o2);
  }
  function m(t2, r2, i2) {
    const s2 = n.value, c2 = s2.selectionEnd, d2 = s2.value.length - c2, p2 = S(t2);
    true === r2 && v();
    const m2 = b(p2), f2 = false !== e.fillMask ? w(m2) : m2, g2 = u.value !== f2;
  ...
  const h2 = { left(e2, t2, o2, n2) {
    ...
    const a2 = e2.value.length, l2 = p(a2), r2 = -1 === l2.slice(0, o2 + 1).indexOf(MARKER);
...
var QInput = createComponent({ name: "QInput", inheritAttrs: false, props: { ...useFieldProps, ...useMaskProps, ...useFormProps, modelValue: { required: false }, shadowText: String, type: { type: String, default: "text" }, debounce: [String, Number], autogrow: Boolean, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...useFieldEmits, "paste", "change"], setup(e, { emit: t, attrs: o }) {
  ...
  const d = ref(null), p = useFormInputNameAttr(e), { innerValue: v, hasMask: m, moveCursorForPaste: f, updateMaskValue: g, onMaskedKeydown: b } = useMask(e, t, B, d), y = useFileFormDomProps(e, true), S = computed(() => fieldValueIsFilled(v.value)), w = useKeyComposition(M), C = useFieldState(), x = computed(() => "textarea" === e.type || true === e.autogrow), k = computed(() => true === x.value || ["text", "search", "url", "tel", "password"].includes(e.type)), _ = computed(() => {
    const t2 = { ...C.splitAttrs.listeners.value, onInput: M, onPaste: $, onChange: E, onBlur: A, onFocus: stop };
    ...
    const t2 = { tabindex: 0, "data-autofocus": true === e.autofocus || void 0, rows: "textarea" === e.type ? 6 : void 0, "aria-label": e.label, name: p.value, ...C.splitAttrs.attributes.value, id: C.targetUid.value, maxlength: e.maxlength, disabled: true === e.disable, readonly: true === e.readonly };
  ...
  function A(t2) {
    void 0 !== t2 && stop(t2), clearTimeout(s), void 0 !== u && u(), r = false, i = false, delete l.value, "file" !== e.type && setTimeout(() => {
  ...
  watch(() => e.type, () => {
    ...
    return h(true === x.value ? "textarea" : "input", { ref: d, class: ["q-field__native q-placeholder", e.inputClass], style: e.inputStyle, ...q.value, ..._.value, ..."file" !== e.type ? { value: O() } : y.value });
  }, getShadowControl: () => {
    return h("div", { class: "q-field__native q-field__shadow absolute-bottom no-pointer-events" + (true === x.value ? "" : " text-no-wrap") }, [h("span", { class: "invisible" }, O()), h("span", e.shadowText)]);
  } });
  const F = useField(C);
  return Object.assign(n, { focus: T, select: P, getNativeElement: () => d.value }), injectProp(n, "nativeEl", () => d.value), F;
} });
...
var QIntersection = createComponent({ name: "QIntersection", props: { tag: { type: String, default: "div" }, once: Boolean, transition: String, transitionDuration: { type: [String, Number], default: 300 }, ssrPrerender: Boolean, margin: String, threshold: [Number, Array], root: { default: null }, disable: Boolean, onVisibility: Function }, setup(e, { slots: t, emit: o }) {
  const n = ref(true === isRuntimeSsrPreHydration.value && e.ssrPrerender), a = computed(() => void 0 !== e.root || void 0 !== e.margin || void 0 !== e.threshold ? { handler: s, cfg: { root: e.root, rootMargin: e.margin, threshold: e.threshold } } : s), l = computed(() => true !== e.disable && (true !== isRuntimeSsrPreHydration.value || true !== e.once || true !== e.ssrPrerender)), r = computed(() => {
    return [[Intersection, a.value, void 0, { once: e.once }]];
  }), i = computed(() => `--q-transition-duration: ${e.transitionDuration}ms`);
  function s(t2) {
...
var QList = createComponent({ name: "QList", props: { ...useDarkProps, bordered: Boolean, dense: Boolean, separator: Boolean, padding: Boolean, tag: { type: String, default: "div" } }, setup(e, { slots: t }) {
  ...
  return () => h(e.tag, { class: a.value, role: "list" }, hSlot(t.default));
} });
...
var QKnob = createComponent({ name: "QKnob", props: { ...useFormProps, ...useCircularCommonProps, modelValue: { type: Number, required: true }, innerMin: Number, innerMax: Number, step: { type: Number, default: 1, validator: (e) => e >= 0 }, tabindex: { type: [Number, String], default: 0 }, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change", "dragValue"], setup(e, { slots: t, emit: o }) {
  ...
  function q(t2, n2) {
    ...
    p2 = r2.top < u.top ? u.left < r2.left ? 90 - p2 : 270 + p2 : u.left < r2.left ? p2 + 90 : 270 - p2, true === a.lang.rtl ? p2 = normalizeToInterval(-p2 - e.angle, 0, 360) : e.angle && (p2 = normalizeToInterval(p2 - e.angle, 0, 360)), true === e.reverse && (p2 = 360 - p2);
    let f2 = e.min + p2 / 360 * (e.max - e.min);
    if (0 !== m.value) {
      const e2 = f2 % m.value;
      f2 = f2 - e2 + (Math.abs(e2) >= m.value / 2 ? (e2 < 0 ? -1 : 1) * m.value : 0), f2 = parseFloat(f2.toFixed(v.value));
    }
    f2 = between(f2, i.value, s.value), o("dragValue", f2), l.value !== f2 && (l.value = f2), P(n2);
  }
  function T(e2) {
  ...
  return () => {
    const o2 = { class: p.value, role: "slider", "aria-valuemin": i.value, "aria-valuemax": s.value, "aria-valuenow": e.modelValue, ...b.value, ...y.value, value: l.value, instantFeedback: f.value, ...g.value }, n2 = { default: t.default };
...
var QScrollObserver = createComponent({ name: "QScrollObserver", props: { axis: { type: String, validator: (e) => axisValues.includes(e), default: "vertical" }, debounce: [String, Number], scrollTarget: { default: void 0 } }, emits: ["scroll"], setup(e, { emit: t }) {
  ...
  return watch(() => c.$q.lang.rtl, r), onMounted(() => {
    a = c.$el.parentNode, i();
  }), onBeforeUnmount(() => {
    null !== l && l(), s();
...
var QLayout = createComponent({ name: "QLayout", props: { container: Boolean, view: { type: String, default: "hhh lpr fff", validator: (e) => /^(h|l)h(h|r) lpr (f|l)f(f|r)$/.test(e.toLowerCase()) }, onScroll: Function, onScrollHeight: Function, onResize: Function }, setup(e, { slots: t, emit: o }) {
  const { proxy: { $q: n } } = getCurrentInstance(), a = ref(null), l = ref(n.screen.height), r = ref(true === e.container ? 0 : n.screen.width), i = ref({ position: 0, direction: "down", inflectionPoint: 0 }), s = ref(0), u = ref(true === isRuntimeSsrPreHydration.value ? 0 : getScrollbarWidth()), c = computed(() => "q-layout q-layout--" + (true === e.container ? "containerized" : "standard")), d = computed(() => false === e.container ? { minHeight: n.screen.height + "px" } : null), p = computed(() => 0 !== u.value ? { [true === n.lang.rtl ? "left" : "right"]: `${u.value}px` } : null), v = computed(() => 0 !== u.value ? { [true === n.lang.rtl ? "right" : "left"]: 0, [true === n.lang.rtl ? "left" : "right"]: `-${u.value}px`, width: `calc(100% + ${u.value}px)` } : null);
  function m(t2) {
  ...
  function f(t2) {
    ...
    let i2 = false;
    l.value !== n2 && (i2 = true, l.value = n2, void 0 !== e.onScrollHeight && o("scrollHeight", n2), b()), r.value !== a2 && (i2 = true, r.value = a2), true === i2 && void 0 !== e.onResize && o("resize", t2);
  }
  ...
  let y;
  const S = { instances: {}, view: computed(() => e.view), isContainer: computed(() => e.container), rootRef: a, height: l, containerHeight: s, scrollbarWidth: u, totalWidth: computed(() => r.value + u.value), rows: computed(() => {
...
var QRadio = createComponent({ name: "QRadio", props: { ...useDarkProps, ...useSizeProps, ...useFormProps, modelValue: { required: true }, val: { required: true }, label: String, leftLabel: Boolean, checkedIcon: String, uncheckedIcon: String, color: String, keepColor: Boolean, dense: Boolean, disable: Boolean, tabindex: [String, Number] }, emits: ["update:modelValue"], setup(e, { slots: t, emit: o }) {
  const { proxy: n } = getCurrentInstance(), a = useDark(e, n.$q), l = useSize(e, optionSizes), r = ref(null), { refocusTargetEl: i, refocusTarget: s } = useRefocusTarget(e, r), u = computed(() => toRaw(e.modelValue) === toRaw(e.val)), c = computed(() => "q-radio cursor-pointer no-outline row inline no-wrap items-center" + (true === e.disable ? " disabled" : "") + (true === a.value ? " q-radio--dark" : "") + (true === e.dense ? " q-radio--dense" : "") + (true === e.leftLabel ? " reverse" : "")), d = computed(() => {
...
var QOptionGroup = createComponent({ name: "QOptionGroup", props: { ...useDarkProps, modelValue: { required: true }, options: { type: Array, validator: (e) => e.every((e2) => "value" in e2 && "label" in e2) }, name: String, type: { default: "radio", validator: (e) => typeValues.includes(e) }, color: String, keepColor: Boolean, dense: Boolean, size: String, leftLabel: Boolean, inline: Boolean, disable: Boolean }, emits: ["update:modelValue"], setup(e, { emit: t, slots: o }) {
  ...
  const l = useDark(e, n), r = computed(() => components$1[e.type]), i = computed(() => "q-option-group q-gutter-x-sm" + (true === e.inline ? " q-option-group--inline" : "")), s = computed(() => {
    const t2 = { role: "group" };
...
var QPage = createComponent({ name: "QPage", props: { padding: Boolean, styleFn: Function }, setup(e, { slots: t }) {
  ...
  }), r = computed(() => `q-page${true === e.padding ? " q-layout-padding" : ""}`);
...
function usePageSticky() {
  ...
  }), a = computed(() => o.header.offset), l = computed(() => o.right.offset), r = computed(() => o.footer.offset), i = computed(() => o.left.offset), s = computed(() => {
    let o2 = 0, s2 = 0;
...
var QPagination = createComponent({ name: "QPagination", props: { ...useDarkProps, modelValue: { type: Number, required: true }, min: { type: [Number, String], default: 1 }, max: { type: [Number, String], required: true }, maxPages: { type: [Number, String], default: 0, validator: (e) => ("string" === typeof e ? parseInt(e, 10) : e) >= 0 }, inputStyle: [Array, String, Object], inputClass: [Array, String, Object], size: String, disable: Boolean, input: Boolean, iconPrev: String, iconNext: String, iconFirst: String, iconLast: String, toFn: Function, boundaryLinks: { type: Boolean, default: null }, boundaryNumbers: { type: Boolean, default: null }, directionLinks: { type: Boolean, default: null }, ellipses: { type: Boolean, default: null }, ripple: { type: [Boolean, Object], default: null }, round: Boolean, rounded: Boolean, flat: Boolean, outline: Boolean, unelevated: Boolean, push: Boolean, glossy: Boolean, color: { type: String, default: "primary" }, textColor: String, activeDesign: { type: String, default: "", values: (e) => "" === e || btnDesignOptions.includes(e) }, activeColor: String, activeTextColor: String, gutter: String, padding: { type: String, default: "3px 2px" } }, emits: ["update:modelValue"], setup(e, { emit: t }) {
  ...
  const f = computed(() => "q-pagination row no-wrap items-center" + (true === e.disable ? " disabled" : "")), g = computed(() => e.gutter in btnPadding ? `${btnPadding[e.gutter]}px` : e.gutter || null), b = computed(() => null !== g.value ? `--q-pagination-gutter-parent:-${g.value};--q-pagination-gutter-child:${g.value}` : null), y = computed(() => {
    ...
    let t2 = Math.max(i.value, 1 + (p.value ? 2 : 0) + (c.value ? 2 : 0));
    ...
    return i.value && t2 < r.value - l.value + 1 && (t2 = 1 + 2 * Math.floor(t2 / 2), o2.pgFrom = Math.max(l.value, Math.min(r.value - t2 + 1, e.modelValue - Math.floor(t2 / 2))), o2.pgTo = Math.min(r.value, o2.pgFrom + t2 - 1), c.value && (o2.boundaryStart = true, o2.pgFrom++), p.value && o2.pgFrom > l.value + (c.value ? 1 : 0) && (o2.ellipsesStart = true, o2.pgFrom++), c.value && (o2.boundaryEnd = true, o2.pgTo--), p.value && o2.pgTo < r.value - (c.value ? 1 : 0) && (o2.ellipsesEnd = true, o2.pgTo--)), o2;
  });
  function q(e2) {
    m.value = e2;
  }
...
var QParallax = createComponent({ name: "QParallax", props: { src: String, height: { type: Number, default: 500 }, speed: { type: Number, default: 1, validator: (e) => e >= 0 && e <= 1 }, scrollTarget: { default: void 0 }, onScroll: Function }, setup(e, { slots: t, emit: o }) {
  ...
  function b() {
    i = true, p = getScrollTarget(a.value, e.scrollTarget), p.addEventListener("scroll", m, passive$1), window.addEventListener("resize", c, passive$1), m();
  }
  function y() {
    true === i && (i = false, p.removeEventListener("scroll", m, passive$1), window.removeEventListener("resize", c, passive$1), p = void 0, f.cancel(), v.cancel(), c.cancel());
  }
  return onMounted(() => {
...
var QPopupEdit = createComponent({ name: "QPopupEdit", props: { modelValue: { required: true }, title: String, buttons: Boolean, labelSet: String, labelCancel: String, color: { type: String, default: "primary" }, validate: { type: Function, default: () => true }, autoSave: Boolean, cover: { type: Boolean, default: true }, disable: Boolean }, emits: ["update:modelValue", "save", "cancel", "beforeShow", "show", "beforeHide", "hide"], setup(e, { slots: t, emit: o }) {
  ...
  let s = false;
  const u = computed(() => {
    return injectProp({ initialValue: r.value, validate: e.validate, set: c, cancel: d, updatePosition: p }, "value", () => i.value, (e2) => {
      i.value = e2;
    });
  });
  function c() {
  ...
  function f() {
    s = false, r.value = cloneDeep(e.modelValue), i.value = cloneDeep(e.modelValue), o("beforeShow");
  }
  function g() {
    o("show");
  }
  function b() {
    false === s && true === v() && (true === e.autoSave && true === e.validate(i.value) ? (o("save", i.value, r.value), o("update:modelValue", i.value)) : o("cancel", i.value, r.value)), o("beforeHide");
  }
  function y() {
    o("hide");
  }
...
var QPopupProxy = createComponent({ name: "QPopupProxy", props: { ...useAnchorProps, breakpoint: { type: [String, Number], default: 450 } }, emits: ["show", "hide"], setup(e, { slots: t, emit: o, attrs: n }) {
  const { proxy: a } = getCurrentInstance(), { $q: l } = a, r = ref(false), i = ref(null), s = computed(() => parseInt(e.breakpoint, 10)), { canShow: u } = useAnchor({ showing: r });
  function c() {
  ...
  return watch(() => c(), (e2) => {
    ...
    const o2 = { ref: i, ...p.value, ...n, onShow: v, onHide: m };
    let a2;
...
var QLinearProgress = createComponent({ name: "QLinearProgress", props: { ...useDarkProps, ...useSizeProps, value: { type: Number, default: 0 }, buffer: Number, color: String, trackColor: String, reverse: Boolean, stripe: Boolean, indeterminate: Boolean, query: Boolean, rounded: Boolean, animationSpeed: { type: [String, Number], default: 2100 }, instantFeedback: Boolean }, setup(e, { slots: t }) {
  const { proxy: o } = getCurrentInstance(), n = useDark(e, o.$q), a = useSize(e, defaultSizes), l = computed(() => true === e.indeterminate || true === e.query), r = computed(() => e.reverse !== e.query), i = computed(() => ({ ...null !== a.value ? a.value : {}, "--q-linear-progress-speed": `${e.animationSpeed}ms` })), s = computed(() => "q-linear-progress" + (void 0 !== e.color ? ` text-${e.color}` : "") + (true === e.reverse || true === e.query ? " q-linear-progress--reverse" : "") + (true === e.rounded ? " rounded-borders" : "")), u = computed(() => width(void 0 !== e.buffer ? e.buffer : 1, r.value, o.$q)), c = computed(() => `q-linear-progress__track absolute-full q-linear-progress__track--with${true === e.instantFeedback ? "out" : ""}-transition q-linear-progress__track--${true === n.value ? "dark" : "light"}` + (void 0 !== e.trackColor ? ` bg-${e.trackColor}` : "")), d = computed(() => width(true === l.value ? 1 : e.value, r.value, o.$q)), p = computed(() => `q-linear-progress__model absolute-full q-linear-progress__model--with${true === e.instantFeedback ? "out" : ""}-transition q-linear-progress__model--${true === l.value ? "in" : ""}determinate`), v = computed(() => ({ width: `${100 * e.value}%` })), m = computed(() => `q-linear-progress__stripe absolute-${true === e.reverse ? "right" : "left"}`);
  return () => {
    const o2 = [h("div", { class: c.value, style: u.value }), h("div", { class: p.value, style: d.value })];
...
var QPullToRefresh = createComponent({ name: "QPullToRefresh", props: { color: String, bgColor: String, icon: String, noMouse: Boolean, disable: Boolean, scrollTarget: { default: void 0 } }, emits: ["refresh"], setup(e, { slots: t, emit: o }) {
  const { proxy: n } = getCurrentInstance(), { $q: a } = n, l = ref("pull"), r = ref(0), i = ref(false), s = ref(-PULLER_HEIGHT), u = ref(false), c = ref({}), d = computed(() => ({ opacity: r.value, transform: `translateY(${s.value}px) rotate(${360 * r.value}deg)` })), p = computed(() => "q-pull-to-refresh__puller row flex-center" + (true === u.value ? " q-pull-to-refresh__puller--animating" : "") + (void 0 !== e.bgColor ? ` bg-${e.bgColor}` : ""));
  function v(e2) {
    if (true === e2.isFinal)
  ...
  }), f = computed(() => `q-pull-to-refresh__content${true === i.value ? " no-pointer-events" : ""}`);
  function g() {
    o("refresh", () => {
...
var QRange = createComponent({ name: "QRange", props: { ...useSliderProps, modelValue: { type: Object, default: () => ({ min: null, max: null }), validator: (e) => "min" in e && "max" in e }, dragRange: Boolean, dragOnlyRange: Boolean, leftLabelColor: String, leftLabelTextColor: String, rightLabelColor: String, rightLabelTextColor: String, leftLabelValue: [String, Number], rightLabelValue: [String, Number], leftThumbColor: String, rightThumbColor: String }, emits: useSliderEmits, setup(e, { emit: t }) {
  const { proxy: { $q: o } } = getCurrentInstance(), { state: n, methods: a } = useSlider({ updateValue: _, updatePosition: T, getDragging: q, formAttrs: computed(() => ({ type: "hidden", name: e.name, value: `${e.modelValue.min}|${e.modelValue.max}` })) }), l = ref(null), r = ref(0), i = ref(0), s = ref({ min: 0, max: 0 });
  function u() {
  ...
  const c = computed(() => a.convertModelToRatio(s.value.min)), d = computed(() => a.convertModelToRatio(s.value.max)), p = computed(() => true === n.active.value ? r.value : c.value), v = computed(() => true === n.active.value ? i.value : d.value), m = computed(() => {
  ...
  function q(t2) {
    const { left: o2, top: n2, width: r2, height: i2 } = l.value.getBoundingClientRect(), u2 = true === e.dragOnlyRange ? 0 : true === e.vertical ? S.value.offsetHeight / (2 * i2) : S.value.offsetWidth / (2 * r2), p2 = { left: o2, top: n2, width: r2, height: i2, valueMin: s.value.min, valueMax: s.value.max, ratioMin: c.value, ratioMax: d.value }, v2 = a.getDraggingRatio(t2, p2);
...
var QScrollArea = createComponent({ name: "QScrollArea", props: { ...useDarkProps, thumbStyle: Object, verticalThumbStyle: Object, horizontalThumbStyle: Object, barStyle: [Array, String, Object], verticalBarStyle: [Array, String, Object], horizontalBarStyle: [Array, String, Object], contentStyle: [Array, String, Object], contentActiveStyle: [Array, String, Object], delay: { type: [String, Number], default: 1e3 }, visible: { type: Boolean, default: null }, tabindex: [String, Number], onScroll: Function }, setup(e, { slots: t, emit: o }) {
  ...
  i.vertical.percentage = computed(() => {
  ...
  }), i.vertical.thumbHidden = computed(() => true !== (null === e.visible ? l.value : e.visible) && false === n.value && false === a.value || i.vertical.size.value <= r.vertical.value + 1), i.vertical.thumbStart = computed(() => i.vertical.percentage.value * (r.vertical.value - i.vertical.thumbSize.value)), i.vertical.thumbSize = computed(() => Math.round(between(r.vertical.value * r.vertical.value / i.vertical.size.value, getMinThumbSize(r.vertical.value), r.vertical.value))), i.vertical.style = computed(() => {
    return { ...e.thumbStyle, ...e.verticalThumbStyle, top: `${i.vertical.thumbStart.value}px`, height: `${i.vertical.thumbSize.value}px` };
  }), i.vertical.thumbClass = computed(() => "q-scrollarea__thumb q-scrollarea__thumb--v absolute-right" + (true === i.vertical.thumbHidden.value ? " q-scrollarea__thumb--invisible" : "")), i.vertical.barClass = computed(() => "q-scrollarea__bar q-scrollarea__bar--v absolute-right" + (true === i.vertical.thumbHidden.value ? " q-scrollarea__bar--invisible" : "")), i.horizontal.percentage = computed(() => {
    const e2 = i.horizontal.size.value - r.horizontal.value;
    if (e2 <= 0)
      return 0;
    const t2 = between(Math.abs(i.horizontal.position.value) / e2, 0, 1);
    return Math.round(1e4 * t2) / 1e4;
  }), i.horizontal.thumbHidden = computed(() => true !== (null === e.visible ? l.value : e.visible) && false === n.value && false === a.value || i.horizontal.size.value <= r.horizontal.value + 1), i.horizontal.thumbStart = computed(() => i.horizontal.percentage.value * (r.horizontal.value - i.horizontal.thumbSize.value)), i.horizontal.thumbSize = computed(() => Math.round(between(r.horizontal.value * r.horizontal.value / i.horizontal.size.value, getMinThumbSize(r.horizontal.value), r.horizontal.value))), i.horizontal.style = computed(() => {
    return { ...e.thumbStyle, ...e.horizontalThumbStyle, [true === s.$q.lang.rtl ? "right" : "left"]: `${i.horizontal.thumbStart.value}px`, width: `${i.horizontal.thumbSize.value}px` };
  }), i.horizontal.thumbClass = computed(() => "q-scrollarea__thumb q-scrollarea__thumb--h absolute-bottom" + (true === i.horizontal.thumbHidden.value ? " q-scrollarea__thumb--invisible" : "")), i.horizontal.barClass = computed(() => "q-scrollarea__bar q-scrollarea__bar--h absolute-bottom" + (true === i.horizontal.thumbHidden.value ? " q-scrollarea__bar--invisible" : ""));
  const m = computed(() => true === i.vertical.thumbHidden.value && true === i.horizontal.thumbHidden.value ? e.contentStyle : e.contentActiveStyle), f = [[TouchPan, (e2) => {
    k(e2, "vertical");
  ...
  return watch(() => s.$q.lang.rtl, (e2) => {
    null !== p.value && setHorizontalScrollPosition(p.value, Math.abs(i.horizontal.position.value) * (true === e2 ? -1 : 1));
  }), onDeactivated(() => {
  ...
  }), onBeforeUnmount(y.cancel), Object.assign(s, { getScrollTarget: () => p.value, getScroll: b, getScrollPosition: () => ({ top: i.vertical.position.value, left: i.horizontal.position.value }), getScrollPercentage: () => ({ top: i.vertical.percentage.value, left: i.horizontal.percentage.value }), setScrollPosition: S, setScrollPercentage(e2, t2, o2) {
    S(e2, t2 * (i[e2].size.value - r[e2].value) * ("horizontal" === e2 && true === s.$q.lang.rtl ? -1 : 1), o2);
  } }), () => {
...
function useVirtualScroll({ virtualScrollLength: e, getVirtualScrollTarget: t, getVirtualScrollEl: o, virtualScrollItemSizeComputed: n }) {
  ...
  function P() {
    ...
    const c2 = Math.floor(a2.scrollMaxSize - Math.max(a2.scrollViewSize, a2.offsetEnd) - Math.min(p[r2], a2.scrollViewSize / 2));
  ...
  function $(t2, o2, n2, a2, r2) {
    ...
    requestAnimationFrame(() => {
      if (u !== o2.scrollStart)
        return;
      true === y2 && M(h2);
      const e2 = p.slice(h2, n2).reduce(sumFn, 0), r3 = e2 + o2.offsetStart + m.value, d3 = r3 + p[n2];
      let v2 = r3 + a2;
      if (void 0 !== c2) {
        const t3 = e2 - k2, a3 = o2.scrollStart + t3;
        v2 = true !== i2 && a3 < r3 && d3 < a3 + o2.scrollViewSize ? a3 : "end" === c2 ? d3 - o2.scrollViewSize : r3 - ("start" === c2 ? 0 : Math.round((o2.scrollViewSize - p[n2]) / 2));
      }
    ...
    if (t2) {
      ...
      for (let e3 = 0; e3 < n2; ) {
        ...
        while (e3 < n2 && true === o2[e3].classList.contains("q-virtual-scroll--with-prev"))
          r2 += a2(o2[e3]), e3++;
        i2 = r2 - p[s2], 0 !== i2 && (p[s2] += i2, v[Math.floor(s2 / aggBucketSize)] += i2), s2++;
      }
    }
  }
  function B() {
  ...
  function O(e2) {
    c !== e2 && (void 0 !== l.onVirtualScroll && r("virtualScroll", { index: e2, from: w.value.from, to: w.value.to - 1, direction: e2 < c ? "decrease" : "increase", ref: i }), c = e2);
  }
  watch(k, () => {
    E();
  }), watch(x, _), E();
  const F = debounce(P, true === s.platform.is.ios ? 120 : 35);
  onBeforeMount(() => {
    E();
  });
  let R = false;
  return onDeactivated(() => {
    ...
    F.cancel();
  }), Object.assign(i, { scrollTo: T, reset: _, refresh: q }), { virtualScrollSliceRange: w, virtualScrollSliceSizeComputed: g, setVirtualScrollSize: E, onVirtualScrollEvt: F, localResetVirtualScroll: Q, padVirtualScroll: A, scrollTo: T, reset: _, refresh: q };
}
...
var QSelect = createComponent({ name: "QSelect", inheritAttrs: false, props: { ...useVirtualScrollProps, ...useFormProps, ...useFieldProps, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: validateNewValueMode }, mapOptions: Boolean, emitValue: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: String, transitionHide: String, transitionDuration: [String, Number], behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: { type: [Number, String], default: void 0 }, onNewValue: Function, onFilter: Function }, emits: [...useFieldEmits, "add", "remove", "inputValue", "newValue", "keyup", "keypress", "keydown", "filterAbort"], setup(e, { slots: t, emit: o }) {
  ...
  const w = ref(null), C = ref(null), x = ref(null), k = ref(null), _ = ref(null), q = useFormInputNameAttr(e), T = useKeyComposition(Te), P = computed(() => Array.isArray(e.options) ? e.options.length : 0), $ = computed(() => void 0 === e.virtualScrollItemSize ? true === e.optionsDense ? 24 : 48 : e.virtualScrollItemSize), { virtualScrollSliceRange: M, virtualScrollSliceSizeComputed: B, localResetVirtualScroll: Q, padVirtualScroll: E, onVirtualScrollEvt: A, scrollTo: O, setVirtualScrollSize: F } = useVirtualScroll({ virtualScrollLength: P, getVirtualScrollTarget: xe, getVirtualScrollEl: Ce, virtualScrollItemSizeComputed: $ }), R = useFieldState(), L = computed(() => {
    ...
    if (true === e.mapOptions && true === Array.isArray(e.options)) {
      const n2 = true === e.mapOptions && void 0 !== p ? p : [], a2 = o2.map((e2) => me(e2, n2));
  ...
  }), z = computed(() => null === e.optionsDark ? R.isDark.value : e.optionsDark), I = computed(() => fieldValueIsFilled(L.value)), V = computed(() => {
  ...
  }), N = computed(() => (true === e.virtualScrollHorizontal ? "q-virtual-scroll--horizontal" : "") + (e.popupContentClass ? " " + e.popupContentClass : "")), H = computed(() => 0 === P.value), j = computed(() => L.value.map((e2) => ne.value(e2)).join(", ")), U = computed(() => true === e.optionsHtml ? () => true : (e2) => void 0 !== e2 && null !== e2 && true === e2.html), K = computed(() => true === e.displayValueHtml || void 0 === e.displayValue && (true === e.optionsHtml || L.value.some(U.value))), W = computed(() => true === R.focused.value ? e.tabindex : -1), Y = computed(() => ({ tabindex: e.tabindex, role: "combobox", "aria-label": e.label, "aria-readonly": true === e.readonly ? "true" : "false", "aria-autocomplete": true === e.useInput ? "list" : "none", "aria-expanded": true === l.value ? "true" : "false", "aria-owns": `${R.targetUid.value}_lb`, "aria-controls": `${R.targetUid.value}_lb` })), G = computed(() => {
    const t2 = { id: `${R.targetUid.value}_lb`, role: "listbox", "aria-multiselectable": true === e.multiple ? "true" : "false" };
    return i.value >= 0 && (t2["aria-activedescendant"] = `${R.targetUid.value}_${i.value}`), t2;
  }), X = computed(() => {
    ...
    return e.options.slice(t2, o2).map((o3, n2) => {
      const r2 = true === ae.value(o3), s2 = t2 + n2, u2 = { clickable: true, active: false, activeClass: te.value, manualFocus: true, focused: false, disable: r2, tabindex: -1, dense: e.optionsDense, dark: z.value, role: "option", id: `${R.targetUid.value}_${s2}`, onClick: () => {
        de(o3);
      } };
  ...
  function de(t2, n2) {
    ...
    if ((true !== v || true === u.value) && R.focus(), ge(), 0 === L.value.length) {
  ...
  function ve(t2 = 1, o2) {
    if (true === l.value) {
      ...
      i.value !== n2 && (pe(n2), O(n2), true !== o2 && true === e.useInput && true === e.fillInput && Pe(n2 >= 0 ? ne.value(e.options[n2]) : g));
    }
  }
  function me(t2, o2) {
  ...
  function we(t2) {
    ...
    if ((void 0 === y || S < Date.now()) && (y = ""), r2 > 0 && true !== e.useInput && void 0 !== t2.key && 1 === t2.key.length && t2.altKey === t2.ctrlKey && (32 !== t2.keyCode || y.length > 0)) {
      ...
      i.value !== s2 && nextTick(() => {
        pe(s2), O(s2), s2 >= 0 && true === e.useInput && true === e.fillInput && Pe(ne.value(e.options[s2]));
      });
      ...
      if (9 !== t2.keyCode && stopAndPrevent(t2), i.value > -1 && i.value < r2)
        ...
        true === l.value ? ze() : true !== R.innerLoading.value && Ie();
      }
  }
  function Ce() {
    return true === v ? _.value : null !== x.value && null !== x.value.contentEl ? x.value.contentEl : void 0;
  }
  function xe() {
    return Ce();
  }
  ...
  function Me(t2, a2, r2) {
    if (void 0 === e.onFilter || true !== a2 && true !== R.focused.value)
      return;
    true === R.innerLoading.value ? o("filterAbort") : (R.innerLoading.value = true, c.value = true), "" !== t2 && true !== e.multiple && L.value.length > 0 && true !== m && t2 === ne.value(L.value[0]) && (t2 = "");
    const i2 = setTimeout(() => {
      true === l.value && (l.value = false);
    }, 10);
    clearTimeout(f), f = i2, o("filter", t2, (e2, t3) => {
      true !== a2 && true !== R.focused.value || f !== i2 || (clearTimeout(f), "function" === typeof e2 && e2(), c.value = false, nextTick(() => {
      ...
      true === R.focused.value && f === i2 && (clearTimeout(f), R.innerLoading.value = false, c.value = false), true === l.value && (l.value = false);
    });
  }
  function Be() {
    return h(QMenu, { ref: x, class: N.value, style: e.popupContentStyle, modelValue: l.value, fit: true !== e.menuShrink, cover: true === e.optionsCover && true !== H.value && true !== e.useInput, anchor: e.menuAnchor, self: e.menuSelf, offset: e.menuOffset, dark: z.value, noParentEvent: true, noRefocus: true, noFocus: true, square: ee.value, transitionShow: e.transitionShow, transitionHide: e.transitionHide, transitionDuration: e.transitionDuration, separateClosePopup: true, ...G.value, onScrollPassive: A, onBeforeShow: Ke, onBeforeHide: Qe, onShow: Ee }, _e);
  }
  function Qe(e2) {
    We(e2), ze();
  }
  ...
  function Fe() {
    const o2 = [h(QField, { class: `col-auto ${R.fieldClass.value}`, ...D.value, for: R.targetUid.value, dark: z.value, square: true, loading: c.value, itemAligned: false, filled: true, stackLabel: s.value.length > 0, ...R.splitAttrs.listeners.value, onFocus: Ae, onBlur: Oe }, { ...t, rawControl: () => R.getControl(true), before: void 0, after: void 0 })];
    return true === l.value && o2.push(h("div", { ref: _, class: N.value + " scroll", style: e.popupContentStyle, ...G.value, onClick: prevent, onScrollPassive: A }, _e())), h(QDialog, { ref: k, modelValue: r.value, position: true === e.useInput ? "top" : void 0, transitionShow: b, transitionHide: e.transitionHide, transitionDuration: e.transitionDuration, onBeforeShow: Ke, onBeforeHide: Re, onHide: Le, onShow: De }, () => h("div", { class: "q-select__dialog" + (true === z.value ? " q-select__dialog--dark q-dark" : "") + (true === u.value ? " q-select__dialog--focused" : "") }, o2));
  }
  function Re(e2) {
  ...
  function De() {
    const e2 = document.activeElement;
    null !== e2 && e2.id === R.targetUid.value || null === C.value || C.value === e2 || C.value.focus(), F();
  }
  function ze() {
    true !== r.value && (i.value = -1, true === l.value && (l.value = false), false === R.focused.value && (clearTimeout(f), f = void 0, true === R.innerLoading.value && (o("filterAbort"), R.innerLoading.value = false, c.value = false)));
  }
  function Ie(o2) {
    true === R.editable.value && (true === v ? (R.onControlFocusin(o2), r.value = true, nextTick(() => {
      R.focus();
...
var QSlideItem = createComponent({ name: "QSlideItem", props: { ...useDarkProps, leftColor: String, rightColor: String, topColor: String, bottomColor: String, onSlide: Function }, emits: ["action", "top", "right", "bottom", "left"], setup(e, { slots: t, emit: o }) {
  ...
  function g(e2) {
    ...
    let a2, l2, r2;
    "X" === u.axis ? (l2 = "left" === e2.direction ? -1 : 1, a2 = 1 === l2 ? p.value.left : p.value.right, r2 = e2.distance.x) : (l2 = "up" === e2.direction ? -2 : 2, a2 = 2 === l2 ? "top" : "bottom", r2 = e2.distance.y), null !== u.dir && Math.abs(l2) !== Math.abs(u.dir) || (u.dir !== l2 && (["left", "right", "top", "bottom"].forEach((e3) => {
...
var QSplitter = createComponent({ name: "QSplitter", props: { ...useDarkProps, modelValue: { type: Number, required: true }, reverse: Boolean, unit: { type: String, default: "%", validator: (e) => ["%", "px"].includes(e) }, limits: { type: Array, validator: (e) => {
  ...
  return watch(() => e.modelValue, (e2) => {
    ...
    const o2 = [h("div", { ref: r.before, class: ["q-splitter__panel q-splitter__before" + (true === e.reverse ? " col" : ""), e.beforeClass], style: p.value.before }, hSlot(t.before)), h("div", { class: ["q-splitter__separator", e.separatorClass], style: e.separatorStyle, "aria-disabled": true === e.disable ? "true" : void 0 }, [hDir("div", { class: "q-splitter__separator-area absolute-full" }, hSlot(t.separator), "sep", true !== e.disable, () => S.value)]), h("div", { ref: r.after, class: ["q-splitter__panel q-splitter__after" + (true === e.reverse ? "" : " col"), e.afterClass], style: p.value.after }, hSlot(t.after))];
...
var QStep = createComponent({ name: "QStep", props: { ...usePanelChildProps, icon: String, color: String, title: { type: String, required: true }, caption: String, prefix: [String, Number], doneIcon: String, doneColor: String, activeIcon: String, activeColor: String, errorIcon: String, errorColor: String, headerNav: { type: Boolean, default: true }, done: Boolean, error: Boolean, onScroll: [Function, Array] }, setup(e, { slots: t, emit: o }) {
  ...
  const { getCacheWithFn: l } = useCache(), r = ref(null), i = computed(() => a.value.modelValue === e.name), s = computed(() => true !== n.platform.is.ios && true === n.platform.is.chrome || true !== i.value || true !== a.value.vertical ? {} : { onScroll(t2) {
    const { target: n2 } = t2;
...
var QStepper = createComponent({ name: "QStepper", props: { ...useDarkProps, ...usePanelProps, flat: Boolean, bordered: Boolean, alternativeLabels: Boolean, headerNav: Boolean, contracted: Boolean, headerClass: String, inactiveColor: String, inactiveIcon: String, doneIcon: String, doneColor: String, activeIcon: String, activeColor: String, errorIcon: String, errorColor: String }, emits: usePanelEmits, setup(e, { slots: t }) {
  const o = getCurrentInstance(), n = useDark(e, o.proxy.$q), { updatePanelsList: a, isValidPanelName: l, updatePanelIndex: r, getPanelContent: i, getPanels: s, panelDirectives: u, goToPanel: c, keepAliveProps: d, needsUniqueKeepAliveWrapper: p } = usePanel();
...
var QVirtualScroll = createComponent({ name: "QVirtualScroll", props: { ...useVirtualScrollProps, type: { type: String, default: "list", validator: (e) => typeOptions.includes(e) }, items: { type: Array, default: () => [] }, itemsFn: Function, itemsSize: Number, scrollTarget: { default: void 0 } }, setup(e, { slots: t, attrs: o }) {
  let n;
  const a = ref(null), l = computed(() => e.itemsSize >= 0 && void 0 !== e.itemsFn ? parseInt(e.itemsSize, 10) : Array.isArray(e.items) ? e.items.length : 0), { virtualScrollSliceRange: r, localResetVirtualScroll: i, padVirtualScroll: s, onVirtualScrollEvt: u } = useVirtualScroll({ virtualScrollLength: l, getVirtualScrollTarget: m, getVirtualScrollEl: v }), c = computed(() => {
    if (0 === l.value)
      return [];
...
function useTablePaginationState(e, t) {
  ...
  }), r = computed(() => void 0 !== l.value.rowsNumber);
  function i(e2) {
...
function useTablePagination(e, t, o, n, a, l) {
  const { props: r, emit: i, proxy: { $q: s } } = e, u = computed(() => true === n.value ? o.value.rowsNumber || 0 : l.value), c = computed(() => {
  ...
  }), void 0 !== r["onUpdate:pagination"] && i("update:pagination", { ...o.value }), { firstRowIndex: c, lastRowIndex: d, isFirstPage: p, isLastPage: m, pagesNumber: v, computedRowsPerPageOptions: f, computedRowsNumber: u, firstPage: h2, prevPage: g, nextPage: b, lastPage: y };
}
...
function useTableRowSelection(e, t, o, n) {
  ...
  return { hasSelectionMode: l, singleSelection: r, multipleSelection: i, allRowsSelected: s, someRowsSelected: u, rowsSelectedNumber: c, isRowSelected: d, clearSelection: p, updateSelection: v };
}
function getVal(e) {
...
var QTable = createComponent({ name: "QTable", props: { rows: { type: Array, default: () => [] }, rowKey: { type: [String, Function], default: "id" }, columns: Array, loading: Boolean, iconFirstPage: String, iconPrevPage: String, iconNextPage: String, iconLastPage: String, title: String, hideHeader: Boolean, grid: Boolean, gridHeader: Boolean, dense: Boolean, flat: Boolean, bordered: Boolean, square: Boolean, separator: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical", "cell", "none"].includes(e) }, wrapCells: Boolean, virtualScroll: Boolean, virtualScrollTarget: { default: void 0 }, ...commonVirtPropsObj, noDataLabel: String, noResultsLabel: String, loadingLabel: String, selectedRowsLabel: Function, rowsPerPageLabel: String, paginationLabel: Function, color: { type: String, default: "grey-8" }, titleClass: [String, Array, Object], tableStyle: [String, Array, Object], tableClass: [String, Array, Object], tableHeaderStyle: [String, Array, Object], tableHeaderClass: [String, Array, Object], cardContainerClass: [String, Array, Object], cardContainerStyle: [String, Array, Object], cardStyle: [String, Array, Object], cardClass: [String, Array, Object], hideBottom: Boolean, hideSelectedBanner: Boolean, hideNoData: Boolean, hidePagination: Boolean, onRowClick: Function, onRowDblclick: Function, onRowContextmenu: Function, ...useDarkProps, ...useFullscreenProps, ...useTableColumnSelectionProps, ...useTableFilterProps, ...useTablePaginationProps, ...useTableRowExpandProps, ...useTableRowSelectionProps, ...useTableSortProps }, emits: ["request", "virtualScroll", ...useFullscreenEmits, ...useTableRowExpandEmits, ...useTableRowSelectionEmits], setup(e, { slots: t, emit: o }) {
  const n = getCurrentInstance(), { proxy: { $q: a } } = n, l = useDark(e, a), { inFullscreen: r, toggleFullscreen: i } = useFullscreen(), s = computed(() => "function" === typeof e.rowKey ? e.rowKey : (t2) => t2[e.rowKey]), u = ref(null), c = ref(null), d = computed(() => true !== e.grid && true === e.virtualScroll), p = computed(() => " q-table__card" + (true === l.value ? " q-table__card--dark q-dark" : "") + (true === e.square ? " q-table--square" : "") + (true === e.flat ? " q-table--flat" : "") + (true === e.bordered ? " q-table--bordered" : "")), v = computed(() => `q-table__container q-table--${e.separator}-separator column no-wrap` + (true === e.grid ? " q-table--grid" : p.value) + (true === l.value ? " q-table--dark" : "") + (true === e.dense ? " q-table--dense" : "") + (false === e.wrapCells ? " q-table--no-wrap" : "") + (true === r.value ? " fullscreen scroll" : "")), m = computed(() => v.value + (true === e.loading ? " q-table--loading" : ""));
  ...
  function le(t2, n2) {
    ...
    if (null !== a2) {
      ...
      n3.scrollTop = l2, o("virtualScroll", { index: t2, from: 0, to: f.value.rowsPerPage - 1, direction: r2 });
    }
  }
  function re(e2) {
    o("virtualScroll", e2);
  ...
  function se(n2, a2, r2) {
    ...
    const p2 = { key: i2, class: { selected: u2 } };
  ...
  function ve(t2) {
    Object.assign(t2, { cols: L.value, colsMap: D.value, sort: N, rowIndex: H.value + t2.pageIndex, color: e.color, dark: l.value, dense: e.dense }), true === P.value && injectProp(t2, "selected", () => A(t2.key), (e2, o2) => {
  ...
  const fe = computed(() => ({ pagination: g.value, pagesNumber: W.value, isFirstPage: U.value, isLastPage: K.value, firstPage: X, prevPage: Z, nextPage: J, lastPage: ee, inFullscreen: r.value, toggleFullscreen: i }));
  function he() {
  ...
  function we(e2) {
    true === Q.value && (e2 = false), F(T.value.map(s.value), T.value, e2);
  }
  const Ce = computed(() => {
  ...
  function Te() {
    const n2 = void 0 !== t.item ? t.item : (n3) => {
      ...
      const r2 = { class: ["q-table__grid-item-card" + p.value, e.cardClass], style: e.cardStyle };
...
var QTime = createComponent({ name: "QTime", props: { ...useDarkProps, ...useFormProps, ...useDatetimeProps, mask: { default: null }, format24h: { type: Boolean, default: null }, defaultDate: { type: String, validator: (e) => /^-?[\d]+\/[0-1]\d\/[0-3]\d$/.test(e) }, options: Function, hourOptions: Array, minuteOptions: Array, secondOptions: Array, withSeconds: Boolean, nowBtn: Boolean }, emits: useDatetimeEmits, setup(e, { slots: t, emit: o }) {
  ...
  }), E = computed(() => null !== M.value ? D(0, 59, M.value) : null), A = computed(() => null !== B.value ? D(0, 59, B.value) : null), O = computed(() => {
    switch (S.value) {
      case "hour":
        return Q.value;
      case "minute":
  ...
  function H() {
    return true === vmIsDestroyed(n) || null !== O.value && (0 === O.value.values.length || "hour" === S.value && true !== _.value && 0 === Q.value[true === C.value ? "am" : "pm"].values.length);
  }
  function j() {
  ...
  function W(e2, t2, o2) {
    ...
    if (i2 = n2.top < t2.top ? t2.left < n2.left ? 90 - i2 : 270 + i2 : t2.left < n2.left ? i2 + 90 : 270 - i2, "hour" === S.value) {
      ...
      r2 = Math.round(i2 / 6) % 60, "minute" === S.value && null !== E.value ? r2 = I(r2, E.value) : "second" === S.value && null !== A.value && (r2 = I(r2, A.value));
...
var QTree = createComponent({ name: "QTree", props: { ...useDarkProps, nodes: { type: Array, required: true }, nodeKey: { type: String, required: true }, labelKey: { type: String, default: "label" }, childrenKey: { type: String, default: "children" }, dense: Boolean, color: String, controlColor: String, textColor: String, selectedColor: String, icon: String, tickStrategy: { type: String, default: "none", validator: (e) => tickStrategyOptions.includes(e) }, ticked: Array, expanded: Array, selected: {}, noSelectionUnset: Boolean, defaultExpandAll: Boolean, accordion: Boolean, filter: String, filterMethod: Function, duration: Number, noConnectors: Boolean, noTransition: Boolean, noNodesLabel: String, noResultsLabel: String }, emits: ["update:expanded", "update:ticked", "update:selected", "lazyLoad", "afterShow", "afterHide"], setup(e, { slots: t, emit: o }) {
  ...
  const c = computed(() => `q-tree q-tree--${true === e.dense ? "dense" : "standard"}` + (true === e.noConnectors ? " q-tree--no-connectors" : "") + (true === l.value ? " q-tree--dark" : "") + (void 0 !== e.color ? ` text-${e.color}` : "")), d = computed(() => void 0 !== e.selected), p = computed(() => e.icon || a.iconSet.tree.icon), v = computed(() => e.controlColor || e.color), m = computed(() => void 0 !== e.textColor ? ` text-${e.textColor}` : ""), f = computed(() => {
    ...
    const t2 = {}, o2 = (n2, a2) => {
      ...
      const w2 = { key: u2, parent: a2, isParent: c2, lazy: S2, disabled: n2.disabled, link: true !== n2.disabled && (true === p2 || true === v2 && (true === c2 || true === S2)), children: [], matchesFilter: !e.filter || g.value(n2, e.filter), selected: u2 === e.selected && true === p2, selectable: p2, expanded: true === c2 && s.value.includes(u2), expandable: v2, noTick: true === n2.noTick || true !== f2 && S2 && "loaded" !== S2, tickable: y2, tickStrategy: l2, hasTicking: m2, strictTicking: f2, leafFilteredTicking: h2, leafTicking: b2, ticked: true === f2 ? i.value.includes(u2) : true !== c2 && i.value.includes(u2) };
  ...
  function _(t2, n2, a2 = y(t2), l2 = b.value[t2]) {
    if (l2.lazy && "loaded" !== l2.lazy) {
      if ("loading" === l2.lazy)
        return;
      r.value[t2] = "loading", true !== Array.isArray(a2[e.childrenKey]) && (a2[e.childrenKey] = []), o("lazyLoad", { node: a2, key: t2, done: (o2) => {
  ...
  function A(o2) {
    ...
    return void 0 !== c2 && (c2 = h("div", { class: "q-tree__node-body relative-position" }, [h("div", { class: m.value }, [c2(d2)])])), h("div", { key: n2, class: `q-tree__node relative-position q-tree__node--${true === s2 ? "parent" : "child"}` }, [h("div", { class: "q-tree__node-header relative-position row no-wrap items-center" + (true === a2.link ? " q-tree__node--link q-hoverable q-focusable" : "") + (true === a2.selected ? " q-tree__node--selected" : "") + (true === a2.disabled ? " q-tree__node--disabled" : ""), tabindex: true === a2.link ? 0 : -1, onClick: (e2) => {
      ...
      true !== shouldIgnoreKey(e2) && (13 === e2.keyCode ? F(o2, a2, e2, true) : 32 === e2.keyCode && R(o2, a2, e2, true));
  ...
  function F(t2, n2, a2, l2) {
    true !== l2 && O(n2.key), d.value && n2.selectable ? false === e.noSelectionUnset ? o("update:selected", n2.key !== e.selected ? n2.key : null) : n2.key !== e.selected && o("update:selected", void 0 === n2.key ? null : n2.key) : R(t2, n2, a2, l2), "function" === typeof t2.handler && t2.handler(t2);
  }
  function R(e2, t2, o2, n2) {
    void 0 !== o2 && stopAndPrevent(o2), true !== n2 && O(t2.key), _(t2.key, !t2.expanded, e2, t2);
  }
  function L(e2, t2) {
...
function getRenderer(e) {
  ...
  function B() {
    false === o.disable && (v.abort(), v.uploadedSize.value = 0, x.value = 0, F(), v.files.value = [], v.queuedFiles.value = [], v.uploadedFiles.value = []);
  }
  function Q() {
  ...
  function I() {
    return h("input", { ref: p, class: "q-uploader__input overflow-hidden absolute-full", tabindex: -1, type: "file", title: "", accept: o.accept, multiple: true === o.multiple ? "multiple" : void 0, capture: o.capture, onMousedown: stop, onClick: m, onChange: L });
  }
  function V() {
  ...
  watch(v.isUploading, (e2, t2) => {
    ...
    true === v.isUploading.value && v.abort(), v.files.value.length > 0 && F();
  });
  const H = {};
  for (const h2 in v)
    true === isRef(v[h2]) ? injectProp(H, h2, () => v[h2].value) : H[h2] = v[h2];
  return Object.assign(H, { upload: D, reset: B, removeUploadedFiles: Q, removeQueuedFiles: E, removeFile: O, pickFiles: m, addFiles: f }), injectMultipleProps(H, { canAddFiles: () => T.value, canUpload: () => P.value, uploadSizeLabel: () => q.value, uploadProgressLabel: () => _.value }), Object.assign(l, H), () => {
...
function injectPlugin({ props: e, emit: t, helpers: o }) {
  const n = ref([]), a = ref([]), l = ref(0), r = computed(() => ({ url: getFn(e.url), method: getFn(e.method), headers: getFn(e.headers), formFields: getFn(e.formFields), fieldName: getFn(e.fieldName), withCredentials: getFn(e.withCredentials), sendRaw: getFn(e.sendRaw), batch: getFn(e.batch) })), i = computed(() => l.value > 0), s = computed(() => a.value.length > 0);
  let u;
  function c() {
    n.value.forEach((e2) => {
      e2.abort();
  ...
  function d() {
    ...
    o.queuedFiles.value = [], r.value.batch(e2) ? p(e2) : e2.forEach((e3) => {
      p([e3]);
    });
  }
  function p(n2) {
...
function morph(e) {
  ...
  const d = r.parentNode, p = r.nextElementSibling, v = getAbsolutePosition(r, l.resize), { width: m, height: f } = getAbsoluteSize(d), { borderWidth: h2, borderStyle: g, borderColor: b, borderRadius: y, backgroundColor: S, transform: w, position: C, cssText: x } = getComputedStyle$1(r, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), k = r.classList.toString(), _ = r.style.cssText, q = r.cloneNode(true), T = true === l.tween ? r.cloneNode(true) : void 0;
  void 0 !== T && (T.className = T.classList.toString().split(" ").filter((e2) => false === /^bg-/.test(e2)).join(" ")), true === l.hideFromClone && q.classList.add("q-morph--internal"), q.setAttribute("aria-hidden", "true"), q.style.transition = "none", q.style.animation = "none", q.style.pointerEvents = "none", d.insertBefore(q, p), r.qMorphCancel = () => {
  ...
  const P = () => {
    ...
    const B = () => {
      ...
      const A = e2 === r && d === a2 ? q : e2.nextElementSibling;
      a2.insertBefore(E, A);
      const { borderWidth: O, borderStyle: F, borderColor: R, borderRadius: L, backgroundColor: D, transform: z, position: I, cssText: V } = getComputedStyle$1(e2, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), N = e2.classList.toString(), H = e2.style.cssText;
      ...
      const j = getAbsolutePosition(e2, l.resize), U = v.left - j.left, K = v.top - j.top, W = v.width / (j.width > 0 ? j.width : 10), Y = v.height / (j.height > 0 ? j.height : 100), G = m - p2, X = f - P2, Z = B2 - $, J = Q - M, ee = Math.max(v.widthM, G), te = Math.max(v.heightM, X), oe = Math.max(j.widthM, Z), ne = Math.max(j.heightM, J), ae = r === e2 && false === ["absolute", "fixed"].includes(I) && false === ["absolute", "fixed"].includes(C);
...
var BottomSheet$1 = createComponent({ name: "BottomSheetPlugin", props: { ...useDarkProps, title: String, message: String, actions: Array, grid: Boolean, cardClass: [String, Array, Object], cardStyle: [String, Array, Object] }, emits: ["ok", "hide"], setup(e, { emit: t }) {
  ...
  return Object.assign(o, { show: l, hide: r }), () => h(QDialog, { ref: a, position: "bottom", onHide: s }, p);
} });
function merge(e, t) {
  for (const o in t)
...
function globalDialog(e, t, o) {
  return (n) => {
    let a, l;
    const r = true === t && void 0 !== n.component;
    if (true === r) {
      const { component: e2, componentProps: t2 } = n;
      a = "string" === typeof e2 ? o.component(e2) : e2, l = t2 || {};
    } else {
      const { class: t2, style: o2, ...r2 } = n;
      a = e, l = r2, void 0 !== t2 && (r2.cardClass = t2), void 0 !== o2 && (r2.cardStyle = o2);
    }
    let i, s = false;
    const u = ref(null), c = createGlobalNode(), d = (e2) => {
      ...
      b.unmount(c), removeGlobalNode(c), b = null, i = null, true !== s && v.forEach((e2) => {
        e2();
      });
    };
...
var DialogPlugin = createComponent({ name: "DialogPlugin", props: { ...useDarkProps, title: String, message: String, prompt: Object, options: Object, progress: [Boolean, Object], html: Boolean, ok: { type: [String, Object, Boolean], default: true }, cancel: [String, Object, Boolean], focus: { type: String, default: "ok", validator: (e) => ["ok", "cancel", "none"].includes(e) }, stackButtons: Boolean, color: String, cardClass: [String, Array, Object], cardStyle: [String, Array, Object] }, emits: ["ok", "hide"], setup(e, { emit: t }) {
  const { proxy: o } = getCurrentInstance(), { $q: n } = o, a = useDark(e, n), l = ref(null), r = ref(void 0 !== e.prompt ? e.prompt.model : void 0 !== e.options ? e.options.model : void 0), i = computed(() => "q-dialog-plugin" + (true === a.value ? " q-dialog-plugin--dark q-dark" : "") + (false !== e.progress ? " q-dialog-plugin--progress" : "")), s = computed(() => e.color || (true === a.value ? "amber" : "primary")), u = computed(() => false === e.progress ? null : true === isObject(e.progress) ? { component: e.progress.spinner || QSpinner, props: { color: e.progress.color || s.value } } : { component: QSpinner, props: { color: s.value } }), c = computed(() => void 0 !== e.prompt || void 0 !== e.options), d = computed(() => {
    if (true !== c.value)
      return {};
  ...
  function q() {
    return [h(QInput, { color: s.value, dense: true, autofocus: true, dark: a.value, ...d.value, modelValue: r.value, "onUpdate:modelValue": x, onKeyup: k })];
  }
  function T() {
    return [h(QOptionGroup, { color: s.value, options: e.options.items, dark: a.value, ...d.value, modelValue: r.value, "onUpdate:modelValue": x })];
  }
  function P() {
    const t2 = [];
...
function diff(e, t) {
  ...
  return void 0 === e ? { add: t, remove: n } : (e.title !== t.title && (o.title = t.title), ["meta", "link", "script", "htmlAttr", "bodyAttr"].forEach((a) => {
    ...
    if (n[a] = [], void 0 !== l && null !== l) {
      o[a] = {};
      for (const e2 in l)
        false === r.hasOwnProperty(e2) && n[a].push(e2);
      for (const e2 in r)
        false === l.hasOwnProperty(e2) ? o[a][e2] = r[e2] : true === changed(l[e2], r[e2]) && (n[a].push(e2), o[a][e2] = r[e2]);
    } else
      o[a] = r;
  }), { add: o, remove: n });
}
...
function addNotification(e, t, o) {
  ...
  const l = (true === Array.isArray(e.actions) ? e.actions : []).concat(true !== e.ignoreDefaults && true === Array.isArray(defaults.actions) ? defaults.actions : []).concat(void 0 !== notifTypes[e.type] && true === Array.isArray(notifTypes[e.type].actions) ? notifTypes[e.type].actions : []), { closeBtn: r } = a;
  if (r && l.push({ label: "string" === typeof r ? r : t.lang.label.close }), a.actions = l.map(({ handler: e2, noDismiss: t2, ...o2 }) => ({ flat: true, ...o2, onClick: "function" === typeof e2 ? () => {
    e2(), true !== t2 && i();
  } : () => {
    i();
    ...
    clearTimeout(o.notif.meta.timer), a.meta.uid = o.notif.meta.uid;
    ...
    if (void 0 === t2) {
      ...
      if (clearTimeout(t2.meta.timer), void 0 !== a.badgePosition) {
  ...
  return a.timeout > 0 && (a.meta.timer = setTimeout(() => {
    ...
    void 0 !== t2 ? logError("trying to update a grouped one which is forbidden", e) : i();
  } : (n = { dismiss: i, config: e, notif: a }, void 0 === o ? (e2) => {
    if (void 0 !== n)
      if (void 0 === e2)
        n.dismiss();
      else {
...
function exportFile(e, t, o = {}) {
  const { mimeType: n, byteOrderMark: a, encoding: l } = "string" === typeof o ? { mimeType: o } : o, r = void 0 !== l ? new TextEncoder(l).encode([t]) : t, i = void 0 !== a ? [a, r] : [r], s = new Blob(i, { type: n || "application/octet-stream" }), u = document.createElement("a");
...
function runSequentialPromises(e, { threadsNumber: t = 1, abortOnFail: o = true } = {}) {
  let n = -1, a = false;
  const { isList: l, totalJobs: r, resultAggregator: i, resultKeys: s } = parsePromises(e), u = () => new Promise((t2, u2) => {
    function c2() {
      const d = ++n;
      if (true === a || d >= r)
        return void t2();
      ...
      e[p](i).then((e2) => {
        true !== a ? (i[p] = { key: p, status: "fulfilled", value: e2 }, setTimeout(c2)) : t2();
      }).catch((e2) => {
        if (true === a)
          return void t2();
        const n2 = { key: p, status: "rejected", reason: e2 };
        if (i[p] = n2, true === o)
          return a = true, void u2({ ...n2, resultAggregator: i });
        setTimeout(c2);
      });
    }
    c2();
...
var Quasar = { version: "2.10.1", install(e, t, o) {
